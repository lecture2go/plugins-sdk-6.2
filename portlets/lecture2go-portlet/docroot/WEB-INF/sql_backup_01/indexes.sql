...
create unique index IX_24BB7F54 on LG_Host (companyId, groupId);
...
create index IX_855A51C9 on LG_StreamingServerTemplate (groupId);
create index IX_AE2CFBE9 on LG_StreamingServerTemplate (streamingServerTemplateId);
...
create index IX_8709B142 on LG_URITemplate (groupId);
create index IX_564EEC6D on LG_URITemplate (type_);

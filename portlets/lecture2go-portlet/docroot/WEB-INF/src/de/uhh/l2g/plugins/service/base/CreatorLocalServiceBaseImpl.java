 ...
 * @generated
 */
public abstract class CreatorLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CreatorLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.CreatorLocalServiceUtil} to access the creator local service.
	 */
	...
	@Override
	public Creator addCreator(Creator creator) throws SystemException {
		creator.setNew(true);
	...
	@Override
	public Creator deleteCreator(long creatorId)
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Creator deleteCreator(Creator creator) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Creator.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return creatorPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return creatorPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return creatorPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Creator fetchCreator(long creatorId) throws SystemException {
	 ...
	 */
	@Override
	public int getCreatorsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Creator updateCreator(Creator creator) throws SystemException {
		return creatorPersistence.update(creator);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Creator",
			creatorLocalService);
	}
	...
	private CreatorLocalServiceClpInvoker _clpInvoker = new CreatorLocalServiceClpInvoker();
}

 ...
 * @generated
 */
public abstract class StatisticLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StatisticLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.StatisticLocalServiceUtil} to access the statistic local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Statistic.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return statisticPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	@Override
	public Statistic fetchStatistic(long statisticId) throws SystemException {
	 ...
	 */
	@Override
	public int getStatisticsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Statistic",
	...
	private StatisticLocalServiceClpInvoker _clpInvoker = new StatisticLocalServiceClpInvoker();
}

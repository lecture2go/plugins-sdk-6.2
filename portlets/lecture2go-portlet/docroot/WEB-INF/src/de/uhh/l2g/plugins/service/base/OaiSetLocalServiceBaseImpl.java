 ...
 * @generated
 */
public abstract class OaiSetLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements OaiSetLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.OaiSetLocalServiceUtil} to access the oai set local service.
	 */
	...
	@Override
	public OaiSet addOaiSet(OaiSet oaiSet) throws SystemException {
		oaiSet.setNew(true);
	...
	@Override
	public OaiSet deleteOaiSet(long oaiSetId)
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OaiSet deleteOaiSet(OaiSet oaiSet) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OaiSet.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return oaiSetPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public OaiSet fetchOaiSet(long oaiSetId) throws SystemException {
	 ...
	 */
	@Override
	public OaiSet getOaiSet(long oaiSetId)
		throws PortalException, SystemException {
	 ...
	 */
	@Override
	public int getOaiSetsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OaiSet updateOaiSet(OaiSet oaiSet) throws SystemException {
		return oaiSetPersistence.update(oaiSet);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.OaiSet",
			oaiSetLocalService);
	}
	...
	private OaiSetLocalServiceClpInvoker _clpInvoker = new OaiSetLocalServiceClpInvoker();
}

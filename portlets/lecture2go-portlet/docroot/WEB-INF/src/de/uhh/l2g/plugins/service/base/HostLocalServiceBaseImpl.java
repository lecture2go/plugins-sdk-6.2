 ...
 * @generated
 */
public abstract class HostLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements HostLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.HostLocalServiceUtil} to access the host local service.
	 */
	...
	@Override
	public Host addHost(Host host) throws SystemException {
		host.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Host deleteHost(Host host) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Host.class,
	 ...
	 */
	@Override
	public List<Host> getHosts(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getHostsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Host updateHost(Host host) throws SystemException {
		return hostPersistence.update(host);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Host",
			hostLocalService);
	}
	...
	private HostLocalServiceClpInvoker _clpInvoker = new HostLocalServiceClpInvoker();
}

 ...
 * @generated
 */
public abstract class TagcloudLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TagcloudLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.TagcloudLocalServiceUtil} to access the tagcloud local service.
	 */
	...
	@Override
	public Tagcloud addTagcloud(Tagcloud tagcloud) throws SystemException {
	...
	@Override
	public Tagcloud deleteTagcloud(long tagcloudId)
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Tagcloud deleteTagcloud(Tagcloud tagcloud) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Tagcloud.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return tagcloudPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return tagcloudPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	@Override
	public Tagcloud fetchTagcloud(long tagcloudId) throws SystemException {
	 ...
	 */
	@Override
	public Tagcloud getTagcloud(long tagcloudId)
		throws PortalException, SystemException {
	 ...
	 */
	@Override
	public int getTagcloudsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Tagcloud updateTagcloud(Tagcloud tagcloud) throws SystemException {
		return tagcloudPersistence.update(tagcloud);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Tagcloud",
	...
	private TagcloudLocalServiceClpInvoker _clpInvoker = new TagcloudLocalServiceClpInvoker();
}

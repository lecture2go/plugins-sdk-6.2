...
import de.uhh.l2g.plugins.service.ServerTemplateLocalService;
...
/**
 * Provides the base implementation for the server template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.ServerTemplateLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class ServerTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServerTemplateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.ServerTemplateLocalServiceUtil} to access the server template local service.
	 */
	...
	@Override
	public ServerTemplate addServerTemplate(ServerTemplate serverTemplate)
		throws SystemException {
		serverTemplate.setNew(true);

		return serverTemplatePersistence.update(serverTemplate);
	}
	 ...
	 */
	@Override
	public ServerTemplate createServerTemplate(long serverTemplateId) {
		return serverTemplatePersistence.create(serverTemplateId);
	}
	...
	@Override
	public ServerTemplate deleteServerTemplate(long serverTemplateId)
		throws PortalException, SystemException {
		return serverTemplatePersistence.remove(serverTemplateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServerTemplate deleteServerTemplate(ServerTemplate serverTemplate)
		throws SystemException {
		return serverTemplatePersistence.remove(serverTemplate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServerTemplate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serverTemplatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serverTemplatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServerTemplate fetchServerTemplate(long serverTemplateId)
		throws SystemException {
		return serverTemplatePersistence.fetchByPrimaryKey(serverTemplateId);
	}
	 ...
	 */
	@Override
	public ServerTemplate getServerTemplate(long serverTemplateId)
		throws PortalException, SystemException {
		return serverTemplatePersistence.findByPrimaryKey(serverTemplateId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serverTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServerTemplate> getServerTemplates(int start, int end)
		throws SystemException {
		return serverTemplatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServerTemplatesCount() throws SystemException {
		return serverTemplatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServerTemplate updateServerTemplate(ServerTemplate serverTemplate)
		throws SystemException {
		return serverTemplatePersistence.update(serverTemplate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.ServerTemplate",
			serverTemplateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serverTemplatePersistence.getDataSource();
	...
	private ServerTemplateLocalServiceClpInvoker _clpInvoker = new ServerTemplateLocalServiceClpInvoker();
}
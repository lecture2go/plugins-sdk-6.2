...
import de.uhh.l2g.plugins.service.Video_FacilityLocalService;
...
/**
 * Provides the base implementation for the video_ facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Video_FacilityLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Video_FacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Video_FacilityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Video_FacilityLocalServiceUtil} to access the video_ facility local service.
	 */
	...
	@Override
	public Video_Facility addVideo_Facility(Video_Facility video_Facility)
		throws SystemException {
		video_Facility.setNew(true);

		return video_FacilityPersistence.update(video_Facility);
	}
	 ...
	 */
	@Override
	public Video_Facility createVideo_Facility(long videoFacilityId) {
		return video_FacilityPersistence.create(videoFacilityId);
	}
	...
	@Override
	public Video_Facility deleteVideo_Facility(long videoFacilityId)
		throws PortalException, SystemException {
		return video_FacilityPersistence.remove(videoFacilityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Video_Facility deleteVideo_Facility(Video_Facility video_Facility)
		throws SystemException {
		return video_FacilityPersistence.remove(video_Facility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Video_Facility.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return video_FacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return video_FacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Video_Facility fetchVideo_Facility(long videoFacilityId)
		throws SystemException {
		return video_FacilityPersistence.fetchByPrimaryKey(videoFacilityId);
	}
	 ...
	 */
	@Override
	public Video_Facility getVideo_Facility(long videoFacilityId)
		throws PortalException, SystemException {
		return video_FacilityPersistence.findByPrimaryKey(videoFacilityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return video_FacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Video_Facility> getVideo_Facilities(int start, int end)
		throws SystemException {
		return video_FacilityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVideo_FacilitiesCount() throws SystemException {
		return video_FacilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Video_Facility updateVideo_Facility(Video_Facility video_Facility)
		throws SystemException {
		return video_FacilityPersistence.update(video_Facility);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Video_Facility",
			video_FacilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = video_FacilityPersistence.getDataSource();
	...
	private Video_FacilityLocalServiceClpInvoker _clpInvoker = new Video_FacilityLocalServiceClpInvoker();
}
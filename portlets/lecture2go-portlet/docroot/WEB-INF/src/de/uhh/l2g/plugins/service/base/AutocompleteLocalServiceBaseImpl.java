...
import de.uhh.l2g.plugins.service.AutocompleteLocalService;
...
/**
 * Provides the base implementation for the autocomplete local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.AutocompleteLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class AutocompleteLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AutocompleteLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.AutocompleteLocalServiceUtil} to access the autocomplete local service.
	 */
	...
	@Override
	public Autocomplete addAutocomplete(Autocomplete autocomplete)
		throws SystemException {
		autocomplete.setNew(true);

		return autocompletePersistence.update(autocomplete);
	}
	 ...
	 */
	@Override
	public Autocomplete createAutocomplete(long autocompleteId) {
		return autocompletePersistence.create(autocompleteId);
	}
	...
	@Override
	public Autocomplete deleteAutocomplete(long autocompleteId)
		throws PortalException, SystemException {
		return autocompletePersistence.remove(autocompleteId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Autocomplete deleteAutocomplete(Autocomplete autocomplete)
		throws SystemException {
		return autocompletePersistence.remove(autocomplete);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Autocomplete.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return autocompletePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return autocompletePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Autocomplete fetchAutocomplete(long autocompleteId)
		throws SystemException {
		return autocompletePersistence.fetchByPrimaryKey(autocompleteId);
	}
	 ...
	 */
	@Override
	public Autocomplete getAutocomplete(long autocompleteId)
		throws PortalException, SystemException {
		return autocompletePersistence.findByPrimaryKey(autocompleteId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return autocompletePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Autocomplete> getAutocompletes(int start, int end)
		throws SystemException {
		return autocompletePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAutocompletesCount() throws SystemException {
		return autocompletePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Autocomplete updateAutocomplete(Autocomplete autocomplete)
		throws SystemException {
		return autocompletePersistence.update(autocomplete);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Autocomplete",
			autocompleteLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = autocompletePersistence.getDataSource();
	...
	private AutocompleteLocalServiceClpInvoker _clpInvoker = new AutocompleteLocalServiceClpInvoker();
}

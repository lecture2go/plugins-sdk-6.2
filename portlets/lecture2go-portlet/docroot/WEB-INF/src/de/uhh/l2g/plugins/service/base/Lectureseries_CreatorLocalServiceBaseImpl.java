...
public abstract class Lectureseries_CreatorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Lectureseries_CreatorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Lectureseries_CreatorLocalServiceUtil} to access the lectureseries_ creator local service.
	 */
	...
	public Lectureseries_Creator deleteLectureseries_Creator(
		long lectureseriesCreatorId) throws PortalException, SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Lectureseries_Creator.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return lectureseries_CreatorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lectureseries_CreatorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Lectureseries_Creator fetchLectureseries_Creator(
		long lectureseriesCreatorId) throws SystemException {
		return lectureseries_CreatorPersistence.fetchByPrimaryKey(lectureseriesCreatorId);
	}
	...
	public Lectureseries_Creator getLectureseries_Creator(
		long lectureseriesCreatorId) throws PortalException, SystemException {
		return lectureseries_CreatorPersistence.findByPrimaryKey(lectureseriesCreatorId);
	}
	 ...
	 */
	@Override
	public List<Lectureseries_Creator> getLectureseries_Creators(int start,
	 ...
	 */
	@Override
	public int getLectureseries_CreatorsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Lectureseries_Creator",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lectureseries_CreatorPersistence.getDataSource();
	...
	private Lectureseries_CreatorLocalServiceClpInvoker _clpInvoker = new Lectureseries_CreatorLocalServiceClpInvoker();
}

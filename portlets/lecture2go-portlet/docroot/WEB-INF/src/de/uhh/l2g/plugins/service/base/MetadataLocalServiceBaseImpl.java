 ...
 * @see de.uhh.l2g.plugins.service.MetadataLocalServiceUtil
 * @generated
 */
public abstract class MetadataLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MetadataLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.MetadataLocalServiceUtil} to access the metadata local service.
	 */
	...
	@Override
	public Metadata addMetadata(Metadata metadata) throws SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Metadata deleteMetadata(Metadata metadata) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Metadata.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return metadataPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return metadataPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	@Override
	public Metadata fetchMetadata(long metadataId) throws SystemException {
	 ...
	 */
	@Override
	public int getMetadatasCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Metadata",
	...
	private MetadataLocalServiceClpInvoker _clpInvoker = new MetadataLocalServiceClpInvoker();
}

...
public class Video_LectureseriesLocalServiceClpInvoker {
	public Video_LectureseriesLocalServiceClpInvoker() {
		...
		_methodName171 = "getNumberOfVideosByLectureseriesAndOpenAccess";

		_methodParameterTypes171 = new String[] { "java.lang.Long", "int" };

		_methodName172 = "getNumberOfVideosByLectureseries";

		_methodParameterTypes172 = new String[] { "java.lang.Long" };

		_methodName173 = "updateOpenAccessByVideo";

		_methodParameterTypes173 = new String[] { "de.uhh.l2g.plugins.model.Video" };
	}

 ...
 * @generated
 */
public abstract class OaiRecordLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements OaiRecordLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.OaiRecordLocalServiceUtil} to access the oai record local service.
	 */
	...
	@Override
	public OaiRecord deleteOaiRecord(long oaiRecordId)
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(OaiRecord.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return oaiRecordPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	@Override
	public OaiRecord fetchOaiRecord(long oaiRecordId) throws SystemException {
	 ...
	 */
	@Override
	public OaiRecord getOaiRecord(long oaiRecordId)
		throws PortalException, SystemException {
	 ...
	 */
	@Override
	public int getOaiRecordsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.OaiRecord",
	...
	private OaiRecordLocalServiceClpInvoker _clpInvoker = new OaiRecordLocalServiceClpInvoker();
}

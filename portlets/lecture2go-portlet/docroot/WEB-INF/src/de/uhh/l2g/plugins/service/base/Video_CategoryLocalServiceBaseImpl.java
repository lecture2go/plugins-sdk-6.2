...
public abstract class Video_CategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Video_CategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Video_CategoryLocalServiceUtil} to access the video_ category local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Video_Category.class,
	 ...
	 */
	@Override
	public int getVideo_CategoriesCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Video_Category",
	...
	private Video_CategoryLocalServiceClpInvoker _clpInvoker = new Video_CategoryLocalServiceClpInvoker();
}

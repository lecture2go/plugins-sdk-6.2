...
import de.uhh.l2g.plugins.service.YearLocalService;
...
import de.uhh.l2g.plugins.service.persistence.YearPersistence;
...
/**
 * Provides the base implementation for the year local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.YearLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class YearLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements YearLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.YearLocalServiceUtil} to access the year local service.
	 */
	...
	@Override
	public Year addYear(Year year) throws SystemException {
		year.setNew(true);

		return yearPersistence.update(year);
	}
	 ...
	 */
	@Override
	public Year createYear(long yearId) {
		return yearPersistence.create(yearId);
	}
	...
	@Override
	public Year deleteYear(long yearId) throws PortalException, SystemException {
		return yearPersistence.remove(yearId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Year deleteYear(Year year) throws SystemException {
		return yearPersistence.remove(year);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Year.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return yearPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return yearPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return yearPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return yearPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Year fetchYear(long yearId) throws SystemException {
		return yearPersistence.fetchByPrimaryKey(yearId);
	}
	 ...
	 */
	@Override
	public Year getYear(long yearId) throws PortalException, SystemException {
		return yearPersistence.findByPrimaryKey(yearId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return yearPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Year> getYears(int start, int end) throws SystemException {
		return yearPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getYearsCount() throws SystemException {
		return yearPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Year updateYear(Year year) throws SystemException {
		return yearPersistence.update(year);
	}
	...
	/**
	 * Returns the year local service.
	 *
	 * @return the year local service
	 */
	public de.uhh.l2g.plugins.service.YearLocalService getYearLocalService() {
		return yearLocalService;
	}

	/**
	 * Sets the year local service.
	 *
	 * @param yearLocalService the year local service
	 */
	public void setYearLocalService(
		de.uhh.l2g.plugins.service.YearLocalService yearLocalService) {
		this.yearLocalService = yearLocalService;
	}

	/**
	 * Returns the year persistence.
	 *
	 * @return the year persistence
	 */
	public YearPersistence getYearPersistence() {
		return yearPersistence;
	}

	/**
	 * Sets the year persistence.
	 *
	 * @param yearPersistence the year persistence
	 */
	public void setYearPersistence(YearPersistence yearPersistence) {
		this.yearPersistence = yearPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Year",
			yearLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"de.uhh.l2g.plugins.model.Year");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = yearPersistence.getDataSource();
	...
	@BeanReference(type = de.uhh.l2g.plugins.service.YearLocalService.class)
	protected de.uhh.l2g.plugins.service.YearLocalService yearLocalService;
	@BeanReference(type = YearPersistence.class)
	protected YearPersistence yearPersistence;
	...
	private YearLocalServiceClpInvoker _clpInvoker = new YearLocalServiceClpInvoker();
}
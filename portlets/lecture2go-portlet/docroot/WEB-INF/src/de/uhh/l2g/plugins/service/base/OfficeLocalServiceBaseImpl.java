 ...
 * @generated
 */
public abstract class OfficeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements OfficeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.OfficeLocalServiceUtil} to access the office local service.
	 */
	...
	@Override
	public Office addOffice(Office office) throws SystemException {
		office.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Office deleteOffice(Office office) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Office.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return officePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Office fetchOffice(long officeId) throws SystemException {
	 ...
	 */
	@Override
	public int getOfficesCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Office",
			officeLocalService);
	}
	...
	private OfficeLocalServiceClpInvoker _clpInvoker = new OfficeLocalServiceClpInvoker();
}

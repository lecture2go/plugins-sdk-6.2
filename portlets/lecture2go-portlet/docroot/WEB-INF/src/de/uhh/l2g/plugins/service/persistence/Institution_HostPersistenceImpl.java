...
public class Institution_HostPersistenceImpl extends BasePersistenceImpl<Institution_Host>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_H",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class,
			...
			Institution_HostModelImpl.HOSTID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<Institution_Host> findByG_H(long groupId, long hostId)
		throws SystemException {
		return findByG_H(groupId, hostId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<Institution_Host> findByG_H(long groupId, long hostId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_H;
			finderArgs = new Object[] { groupId, hostId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_H;
			finderArgs = new Object[] {
					groupId, hostId,
	 ...
	 */
	@Override
	public Institution_Host findByG_H_First(long groupId, long hostId,
		OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByG_H_First(groupId, hostId,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByG_H_First(long groupId, long hostId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Institution_Host> list = findByG_H(groupId, hostId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host findByG_H_Last(long groupId, long hostId,
		OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByG_H_Last(groupId, hostId,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByG_H_Last(long groupId, long hostId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Institution_Host> list = findByG_H(groupId, hostId, count - 1,
	 ...
	 */
	@Override
	public Institution_Host[] findByG_H_PrevAndNext(long institutionHostId,
		long groupId, long hostId, OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = findByPrimaryKey(institutionHostId);
		...
		try {
			...
			array[0] = getByG_H_PrevAndNext(session, institution_Host, groupId,
					hostId, orderByComparator, true);

			array[1] = institution_Host;

			array[2] = getByG_H_PrevAndNext(session, institution_Host, groupId,
					hostId, orderByComparator, false);
	...
	protected Institution_Host getByG_H_PrevAndNext(Session session,
		Institution_Host institution_Host, long groupId, long hostId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_H(long groupId, long hostId)
		throws SystemException {
		for (Institution_Host institution_Host : findByG_H(groupId, hostId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(institution_Host);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_H_GROUPID_2 = "institution_Host.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_H_HOSTID_2 = "institution_Host.hostId = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_G_I = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByG_I",
			new String[] { Long.class.getName(), Long.class.getName() },
			Institution_HostModelImpl.GROUPID_COLUMN_BITMASK |
			Institution_HostModelImpl.INSTITUTIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_I = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((institution_Host.getGroupId() != groupId) ||
							(institution_Host.getInstitutionId() != institutionId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_I,
	...
	private static final String _FINDER_COLUMN_G_I_GROUPID_2 = "institution_Host.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_I_INSTITUTIONID_2 = "institution_Host.institutionId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			Institution_HostModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Institution_Host> findByGroupId(long groupId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Institution_Host> findByGroupId(long groupId, int start,
	 ...
	 */
	@Override
	public Institution_Host findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByGroupId_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByGroupId_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Institution_Host> list = findByGroupId(groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByGroupId_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByGroupId_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Institution_Host> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	...
	public Institution_Host[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, institution_Host,
					groupId, orderByComparator, true);

			array[1] = institution_Host;

			array[2] = getByGroupId_PrevAndNext(session, institution_Host,
	...
	protected Institution_Host getByGroupId_PrevAndNext(Session session,
		Institution_Host institution_Host, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Institution_Host institution_Host : findByGroupId(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(institution_Host);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "institution_Host.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_G_H",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class,
			...
			Institution_HostModelImpl.GROUPID_COLUMN_BITMASK |
			Institution_HostModelImpl.HOSTID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_H = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Institution_Host> findByC_G_H(long companyId, long groupId,
		long hostId) throws SystemException {
		return findByC_G_H(companyId, groupId, hostId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<Institution_Host> findByC_G_H(long companyId, long groupId,
		long hostId, int start, int end) throws SystemException {
	...
	@Override
	public List<Institution_Host> findByC_G_H(long companyId, long groupId,
		long hostId, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
	 ...
	 */
	@Override
	public Institution_Host findByC_G_H_First(long companyId, long groupId,
		long hostId, OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByC_G_H_First(companyId,
	 ...
	 */
	@Override
	public Institution_Host fetchByC_G_H_First(long companyId, long groupId,
		long hostId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Institution_Host> list = findByC_G_H(companyId, groupId, hostId,
	 ...
	 */
	@Override
	public Institution_Host findByC_G_H_Last(long companyId, long groupId,
		long hostId, OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByC_G_H_Last(companyId,
				groupId, hostId, orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByC_G_H_Last(long companyId, long groupId,
		long hostId, OrderByComparator orderByComparator)
		throws SystemException {
	 ...
	 */
	@Override
	public Institution_Host[] findByC_G_H_PrevAndNext(long institutionHostId,
		...
		try {
			...
			array[0] = getByC_G_H_PrevAndNext(session, institution_Host,
					companyId, groupId, hostId, orderByComparator, true);

			array[1] = institution_Host;

			array[2] = getByC_G_H_PrevAndNext(session, institution_Host,
					companyId, groupId, hostId, orderByComparator, false);
	...
	protected Institution_Host getByC_G_H_PrevAndNext(Session session,
		Institution_Host institution_Host, long companyId, long groupId,
		long hostId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_G_H(long companyId, long groupId, long hostId)
		throws SystemException {
		for (Institution_Host institution_Host : findByC_G_H(companyId,
	...
	public int countByC_G_H(long companyId, long groupId, long hostId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_G_H;
	...
	private static final String _FINDER_COLUMN_C_G_H_COMPANYID_2 = "institution_Host.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_H_GROUPID_2 = "institution_Host.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_H_HOSTID_2 = "institution_Host.hostId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_I = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_G_I",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_I = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED,
			Institution_HostImpl.class,
			...
			Institution_HostModelImpl.GROUPID_COLUMN_BITMASK |
			Institution_HostModelImpl.INSTITUTIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_I = new FinderPath(Institution_HostModelImpl.ENTITY_CACHE_ENABLED,
			Institution_HostModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Institution_Host> findByC_G_I(long companyId, long groupId,
		long institutionId) throws SystemException {
		return findByC_G_I(companyId, groupId, institutionId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Institution_Host> findByC_G_I(long companyId, long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_I;
	 ...
	 */
	@Override
	public Institution_Host findByC_G_I_First(long companyId, long groupId,
		long institutionId, OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByC_G_I_First(companyId,
	 ...
	 */
	@Override
	public Institution_Host fetchByC_G_I_First(long companyId, long groupId,
		long institutionId, OrderByComparator orderByComparator)
		throws SystemException {
		List<Institution_Host> list = findByC_G_I(companyId, groupId,
	 ...
	 */
	@Override
	public Institution_Host findByC_G_I_Last(long companyId, long groupId,
		long institutionId, OrderByComparator orderByComparator)
		throws NoSuchInstitution_HostException, SystemException {
		Institution_Host institution_Host = fetchByC_G_I_Last(companyId,
				groupId, institutionId, orderByComparator);
	 ...
	 */
	@Override
	public Institution_Host fetchByC_G_I_Last(long companyId, long groupId,
		long institutionId, OrderByComparator orderByComparator)
		throws SystemException {
	 ...
	 */
	@Override
	public Institution_Host[] findByC_G_I_PrevAndNext(long institutionHostId,
		...
		try {
			...
			array[0] = getByC_G_I_PrevAndNext(session, institution_Host,
					companyId, groupId, institutionId, orderByComparator, true);

			array[1] = institution_Host;

			array[2] = getByC_G_I_PrevAndNext(session, institution_Host,
					companyId, groupId, institutionId, orderByComparator, false);
	...
	protected Institution_Host getByC_G_I_PrevAndNext(Session session,
		Institution_Host institution_Host, long companyId, long groupId,
		long institutionId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_G_I(long companyId, long groupId, long institutionId)
		throws SystemException {
		for (Institution_Host institution_Host : findByC_G_I(companyId,
				groupId, institutionId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(institution_Host);
		}
	}
	...
	public int countByC_G_I(long companyId, long groupId, long institutionId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_G_I;
	...
	private static final String _FINDER_COLUMN_C_G_I_COMPANYID_2 = "institution_Host.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_I_GROUPID_2 = "institution_Host.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_I_INSTITUTIONID_2 = "institution_Host.institutionId = ?";
	...
	public Institution_Host updateImpl(
		...
		if (isNew || !Institution_HostModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((institution_HostModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						institution_HostModelImpl.getOriginalGroupId(),
						institution_HostModelImpl.getOriginalHostId()
					};
				...
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_H,
					args);
			...
			if ((institution_HostModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_I.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						institution_HostModelImpl.getOriginalCompanyId(),
						institution_HostModelImpl.getOriginalGroupId(),
						institution_HostModelImpl.getOriginalInstitutionId()
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_G_I, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_G_I,
					args);
	...
	protected Institution_Host toUnwrappedModel(
		...
		institution_HostImpl.setGroupId(institution_Host.getGroupId());
		institution_HostImpl.setCompanyId(institution_Host.getCompanyId());

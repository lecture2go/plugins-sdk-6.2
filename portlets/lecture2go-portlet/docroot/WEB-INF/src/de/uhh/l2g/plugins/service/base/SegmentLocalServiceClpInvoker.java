...
public class SegmentLocalServiceClpInvoker {
	public SegmentLocalServiceClpInvoker() {
		...
		_methodName174 = "deleteThumbhailsFromSegments";

		_methodParameterTypes174 = new String[] { "java.util.List" };

		_methodName175 = "deleteThumbhailsFromSegment";

		_methodParameterTypes175 = new String[] {
				"de.uhh.l2g.plugins.model.Segment"
			};

		_methodName176 = "getSegmentsByVideoId";

		_methodParameterTypes176 = new String[] { "java.lang.Long" };

		_methodName177 = "getSegmentById";

		_methodParameterTypes177 = new String[] { "java.lang.Long" };

		_methodName178 = "fillWithProperties";

		_methodParameterTypes178 = new String[] {
				"de.uhh.l2g.plugins.model.Segment"
			};

		_methodName179 = "deleteByVideoId";

		_methodParameterTypes179 = new String[] { "java.lang.Long" };

		_methodName180 = "createSegment";

		_methodParameterTypes180 = new String[] {
				"de.uhh.l2g.plugins.model.Segment"
			};

		_methodName181 = "removeSegment";

		_methodParameterTypes181 = new String[] { "java.lang.Long" };

		_methodName182 = "getPreviusSegment";

		_methodParameterTypes182 = new String[] {
				"de.uhh.l2g.plugins.model.Segment"
			};

		_methodName183 = "getPreviusSegmentId";

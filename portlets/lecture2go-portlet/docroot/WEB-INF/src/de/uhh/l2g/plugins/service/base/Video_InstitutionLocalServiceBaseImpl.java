...
public abstract class Video_InstitutionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Video_InstitutionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Video_InstitutionLocalServiceUtil} to access the video_ institution local service.
	 */
	...
	public Video_Institution addVideo_Institution(
		Video_Institution video_Institution) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Video_Institution.class,
	...
	public Video_Institution fetchVideo_Institution(long videoInstitutionId)
		throws SystemException {
		return video_InstitutionPersistence.fetchByPrimaryKey(videoInstitutionId);
	}
	...
	public Video_Institution getVideo_Institution(long videoInstitutionId)
		throws PortalException, SystemException {
		return video_InstitutionPersistence.findByPrimaryKey(videoInstitutionId);
	}
	 ...
	 */
	@Override
	public int getVideo_InstitutionsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Video_Institution",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = video_InstitutionPersistence.getDataSource();
	...
	private Video_InstitutionLocalServiceClpInvoker _clpInvoker = new Video_InstitutionLocalServiceClpInvoker();
}

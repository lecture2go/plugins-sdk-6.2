...
import de.uhh.l2g.plugins.service.Segment_User_VideoLocalService;
...
/**
 * Provides the base implementation for the segment_ user_ video local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Segment_User_VideoLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Segment_User_VideoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Segment_User_VideoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Segment_User_VideoLocalServiceUtil} to access the segment_ user_ video local service.
	 */
	...
	@Override
	public Segment_User_Video addSegment_User_Video(
		Segment_User_Video segment_User_Video) throws SystemException {
		segment_User_Video.setNew(true);

		return segment_User_VideoPersistence.update(segment_User_Video);
	}
	 ...
	 */
	@Override
	public Segment_User_Video createSegment_User_Video(long segmentUserVideoId) {
		return segment_User_VideoPersistence.create(segmentUserVideoId);
	}
	...
	@Override
	public Segment_User_Video deleteSegment_User_Video(long segmentUserVideoId)
		throws PortalException, SystemException {
		return segment_User_VideoPersistence.remove(segmentUserVideoId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Segment_User_Video deleteSegment_User_Video(
		Segment_User_Video segment_User_Video) throws SystemException {
		return segment_User_VideoPersistence.remove(segment_User_Video);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Segment_User_Video.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return segment_User_VideoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return segment_User_VideoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Segment_User_Video fetchSegment_User_Video(long segmentUserVideoId)
		throws SystemException {
		return segment_User_VideoPersistence.fetchByPrimaryKey(segmentUserVideoId);
	}
	 ...
	 */
	@Override
	public Segment_User_Video getSegment_User_Video(long segmentUserVideoId)
		throws PortalException, SystemException {
		return segment_User_VideoPersistence.findByPrimaryKey(segmentUserVideoId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return segment_User_VideoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Segment_User_Video> getSegment_User_Videos(int start, int end)
		throws SystemException {
		return segment_User_VideoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSegment_User_VideosCount() throws SystemException {
		return segment_User_VideoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Segment_User_Video updateSegment_User_Video(
		Segment_User_Video segment_User_Video) throws SystemException {
		return segment_User_VideoPersistence.update(segment_User_Video);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Segment_User_Video",
			segment_User_VideoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = segment_User_VideoPersistence.getDataSource();
	...
	private Segment_User_VideoLocalServiceClpInvoker _clpInvoker = new Segment_User_VideoLocalServiceClpInvoker();
}
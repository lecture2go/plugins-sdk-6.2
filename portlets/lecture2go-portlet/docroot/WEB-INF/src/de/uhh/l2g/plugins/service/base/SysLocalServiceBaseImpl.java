 ...
 * @see de.uhh.l2g.plugins.service.SysLocalServiceUtil
 * @generated
 */
public abstract class SysLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SysLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.SysLocalServiceUtil} to access the sys local service.
	 */
	...
	@Override
	public Sys addSys(Sys sys) throws SystemException {
		sys.setNew(true);
	...
	@Override
	public Sys deleteSys(int sysId) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Sys deleteSys(Sys sys) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Sys.class,
	...
	@Override
	public Sys fetchSys(int sysId) throws SystemException {
	 ...
	 */
	@Override
	public Sys getSys(int sysId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Sys> getSyses(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getSysesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Sys updateSys(Sys sys) throws SystemException {
		return sysPersistence.update(sys);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Sys",
			sysLocalService);
	}
	...
	private SysLocalServiceClpInvoker _clpInvoker = new SysLocalServiceClpInvoker();
}

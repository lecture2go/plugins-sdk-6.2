...
public class Lectureseries_CreatorPersistenceImpl extends BasePersistenceImpl<Lectureseries_Creator>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LECTURESERIESCREATOR =
		new FinderPath(Lectureseries_CreatorModelImpl.ENTITY_CACHE_ENABLED,
			Lectureseries_CreatorModelImpl.FINDER_CACHE_ENABLED,
			Lectureseries_CreatorImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LECTURESERIESCREATOR =
		new FinderPath(Lectureseries_CreatorModelImpl.ENTITY_CACHE_ENABLED,
			Lectureseries_CreatorModelImpl.FINDER_CACHE_ENABLED,
			Lectureseries_CreatorImpl.class,
			...
			Lectureseries_CreatorModelImpl.LECTURESERIESID_COLUMN_BITMASK |
			Lectureseries_CreatorModelImpl.CREATORID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_LECTURESERIESCREATOR = new FinderPath(Lectureseries_CreatorModelImpl.ENTITY_CACHE_ENABLED,
			Lectureseries_CreatorModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	public List<Lectureseries_Creator> findByLectureseriesCreator(
		long lectureseriesId, long creatorId) throws SystemException {
		return findByLectureseriesCreator(lectureseriesId, creatorId,
	...
	public List<Lectureseries_Creator> findByLectureseriesCreator(
		...
		throws SystemException {
		return findByLectureseriesCreator(lectureseriesId, creatorId, start,
			end, null);
	}
	...
	public List<Lectureseries_Creator> findByLectureseriesCreator(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LECTURESERIESCREATOR;
			finderArgs = new Object[] { lectureseriesId, creatorId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LECTURESERIESCREATOR;
			finderArgs = new Object[] {
	...
	public Lectureseries_Creator findByLectureseriesCreator_First(
		...
		OrderByComparator orderByComparator)
		throws NoSuchLectureseries_CreatorException, SystemException {
		Lectureseries_Creator lectureseries_Creator = fetchByLectureseriesCreator_First(lectureseriesId,
	...
	public Lectureseries_Creator fetchByLectureseriesCreator_First(
		long lectureseriesId, long creatorId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Lectureseries_Creator> list = findByLectureseriesCreator(lectureseriesId,
	...
	public Lectureseries_Creator findByLectureseriesCreator_Last(
		...
		OrderByComparator orderByComparator)
		throws NoSuchLectureseries_CreatorException, SystemException {
		Lectureseries_Creator lectureseries_Creator = fetchByLectureseriesCreator_Last(lectureseriesId,
				creatorId, orderByComparator);
	...
	public Lectureseries_Creator[] findByLectureseriesCreator_PrevAndNext(
		...
		try {
			...
			array[0] = getByLectureseriesCreator_PrevAndNext(session,
					lectureseries_Creator, lectureseriesId, creatorId,
					orderByComparator, true);

			array[1] = lectureseries_Creator;

			array[2] = getByLectureseriesCreator_PrevAndNext(session,
					lectureseries_Creator, lectureseriesId, creatorId,
	 ...
	 */
	@Override
	public void removeByLectureseriesCreator(long lectureseriesId,
		long creatorId) throws SystemException {
		for (Lectureseries_Creator lectureseries_Creator : findByLectureseriesCreator(
	 ...
	 */
	@Override
	public int countByLectureseriesCreator(long lectureseriesId, long creatorId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_LECTURESERIESCREATOR;
	...
	private static final String _FINDER_COLUMN_LECTURESERIESCREATOR_LECTURESERIESID_2 =
		"lectureseries_Creator.lectureseriesId = ? AND ";
	private static final String _FINDER_COLUMN_LECTURESERIESCREATOR_CREATORID_2 = "lectureseries_Creator.creatorId = ?";
	...
	public Lectureseries_Creator updateImpl(
		...
		if (isNew || !Lectureseries_CreatorModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((lectureseries_CreatorModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LECTURESERIESCREATOR.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						lectureseries_CreatorModelImpl.getOriginalLectureseriesId(),
						lectureseries_CreatorModelImpl.getOriginalCreatorId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_LECTURESERIESCREATOR,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LECTURESERIESCREATOR,
					args);

 ...
 * @generated
 */
public abstract class ProducerLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ProducerLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.ProducerLocalServiceUtil} to access the producer local service.
	 */
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Producer deleteProducer(Producer producer) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Producer.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return producerPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	@Override
	public Producer fetchProducer(long producerId) throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Producer",
	...
	private ProducerLocalServiceClpInvoker _clpInvoker = new ProducerLocalServiceClpInvoker();
}

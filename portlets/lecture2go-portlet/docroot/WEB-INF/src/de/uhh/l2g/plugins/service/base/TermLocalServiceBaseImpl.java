 ...
 * @generated
 */
public abstract class TermLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TermLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.TermLocalServiceUtil} to access the term local service.
	 */
	...
	@Override
	public Term addTerm(Term term) throws SystemException {
		term.setNew(true);
	...
	@Override
	public Term deleteTerm(long termId) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Term deleteTerm(Term term) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Term.class,
	...
	@Override
	public Term fetchTerm(long termId) throws SystemException {
	 ...
	 */
	@Override
	public Term getTerm(long termId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Term> getTerms(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getTermsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Term updateTerm(Term term) throws SystemException {
		return termPersistence.update(term);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Term",
			termLocalService);
	}
	...
	private TermLocalServiceClpInvoker _clpInvoker = new TermLocalServiceClpInvoker();
}

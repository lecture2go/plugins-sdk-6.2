...
public class Lectureseries_CategoryPersistenceImpl extends BasePersistenceImpl<Lectureseries_Category>
	...
	public List<Lectureseries_Category> findByCategoryLectureseries(
		long categoryId, long lectureseriesId) throws SystemException {
	...
	public Lectureseries_Category updateImpl(
		...
		if (isNew || !Lectureseries_CategoryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((lectureseries_CategoryModelImpl.getColumnBitmask() &
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_CATEGORYLECTURESERIES,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CATEGORYLECTURESERIES,
					args);

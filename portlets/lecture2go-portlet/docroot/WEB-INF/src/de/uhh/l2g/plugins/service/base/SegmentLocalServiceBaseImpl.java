 ...
 * @generated
 */
public abstract class SegmentLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SegmentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.SegmentLocalServiceUtil} to access the segment local service.
	 */
	...
	@Override
	public Segment addSegment(Segment segment) throws SystemException {
		segment.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Segment deleteSegment(Segment segment) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Segment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return segmentPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return segmentPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return segmentPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	 ...
	 */
	@Override
	public int getSegmentsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Segment updateSegment(Segment segment) throws SystemException {
		return segmentPersistence.update(segment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Segment",
			segmentLocalService);
	}
	...
	private SegmentLocalServiceClpInvoker _clpInvoker = new SegmentLocalServiceClpInvoker();
}

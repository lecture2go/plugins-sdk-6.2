...
public class CategoryLocalServiceClpInvoker {
	public CategoryLocalServiceClpInvoker() {
		...
		_methodName166 = "getAllCategories";

		_methodParameterTypes166 = new String[] { "int", "int" };

		_methodName167 = "getByName";
		...
		_methodName169 = "getCategoriesFromLectureseriesIdsAndVideoIds";

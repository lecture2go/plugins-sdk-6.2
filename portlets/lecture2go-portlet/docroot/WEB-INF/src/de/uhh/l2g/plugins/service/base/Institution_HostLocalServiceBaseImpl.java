...
public abstract class Institution_HostLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Institution_HostLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Institution_HostLocalServiceUtil} to access the institution_ host local service.
	 */
	...
	public Institution_Host addInstitution_Host(
		Institution_Host institution_Host) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Institution_Host.class,
	 ...
	 */
	@Override
	public int getInstitution_HostsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Institution_Host",
	...
	private Institution_HostLocalServiceClpInvoker _clpInvoker = new Institution_HostLocalServiceClpInvoker();
}

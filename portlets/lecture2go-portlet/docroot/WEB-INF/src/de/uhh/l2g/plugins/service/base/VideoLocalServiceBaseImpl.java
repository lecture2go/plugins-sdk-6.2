...
public abstract class VideoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VideoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.VideoLocalServiceUtil} to access the video local service.
	 */
	...
	@Override
	public Video addVideo(Video video) throws SystemException {
		video.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Video deleteVideo(Video video) throws SystemException {
	...
	@Override
	public Video fetchVideo(long videoId) throws SystemException {
	 ...
	 */
	@Override
	public Video getVideo(long videoId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Video> getVideos(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getVideosCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Video updateVideo(Video video) throws SystemException {
		return videoPersistence.update(video);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Video",
			videoLocalService);
	}
	...
	private VideoLocalServiceClpInvoker _clpInvoker = new VideoLocalServiceClpInvoker();
}

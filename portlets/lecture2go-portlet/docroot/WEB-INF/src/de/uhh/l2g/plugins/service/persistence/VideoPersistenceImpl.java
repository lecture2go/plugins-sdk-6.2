...
public class VideoPersistenceImpl extends BasePersistenceImpl<Video>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LICENSE = new FinderPath(VideoModelImpl.ENTITY_CACHE_ENABLED,
			VideoModelImpl.FINDER_CACHE_ENABLED, VideoImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LICENSE =
		new FinderPath(VideoModelImpl.ENTITY_CACHE_ENABLED,
			VideoModelImpl.FINDER_CACHE_ENABLED, VideoImpl.class,
			...
			VideoModelImpl.UPLOADDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_LICENSE = new FinderPath(VideoModelImpl.ENTITY_CACHE_ENABLED,
			VideoModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Video> findByLicense(long licenseId) throws SystemException {
		return findByLicense(licenseId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<Video> findByLicense(long licenseId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LICENSE;
			finderArgs = new Object[] { licenseId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LICENSE;
	 ...
	 */
	@Override
	public Video findByLicense_First(long licenseId,
		OrderByComparator orderByComparator)
		throws NoSuchVideoException, SystemException {
	 ...
	 */
	@Override
	public Video fetchByLicense_First(long licenseId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Video findByLicense_Last(long licenseId,
		OrderByComparator orderByComparator)
		throws NoSuchVideoException, SystemException {
	 ...
	 */
	@Override
	public Video fetchByLicense_Last(long licenseId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Video> list = findByLicense(licenseId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Video[] findByLicense_PrevAndNext(long videoId, long licenseId,
		OrderByComparator orderByComparator)
		throws NoSuchVideoException, SystemException {
		Video video = findByPrimaryKey(videoId);
		...
		try {
			...
			array[0] = getByLicense_PrevAndNext(session, video, licenseId,
					orderByComparator, true);

			array[1] = video;

			array[2] = getByLicense_PrevAndNext(session, video, licenseId,
					orderByComparator, false);
	...
	protected Video getByLicense_PrevAndNext(Session session, Video video,
		long licenseId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByLicense(long licenseId) throws SystemException {
		for (Video video : findByLicense(licenseId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(video);
		}
	}
	 ...
	 */
	@Override
	public int countByLicense(long licenseId) throws SystemException {
	...
	private static final String _FINDER_COLUMN_LICENSE_LICENSEID_2 = "video.licenseId = ?";
	...
	public Video updateImpl(de.uhh.l2g.plugins.model.Video video)
		...
		if (isNew || !VideoModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((videoModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LICENSE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						videoModelImpl.getOriginalLicenseId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_LICENSE, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LICENSE,
					args);
	...
	protected Video toUnwrappedModel(Video video) {
		...
		videoImpl.setLicenseId(video.getLicenseId());

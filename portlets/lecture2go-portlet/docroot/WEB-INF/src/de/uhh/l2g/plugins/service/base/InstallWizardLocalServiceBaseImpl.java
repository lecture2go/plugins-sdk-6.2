...
import de.uhh.l2g.plugins.service.InstallWizardLocalService;
...
/**
 * Provides the base implementation for the install wizard local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.InstallWizardLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 * @see de.uhh.l2g.plugins.service.impl.InstallWizardLocalServiceImpl
 * @see de.uhh.l2g.plugins.service.InstallWizardLocalServiceUtil
 * @generated
 */
public abstract class InstallWizardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InstallWizardLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.InstallWizardLocalServiceUtil} to access the install wizard local service.
	 */
	...
	@Override
	public InstallWizard addInstallWizard(InstallWizard installWizard)
		throws SystemException {
		installWizard.setNew(true);

		return installWizardPersistence.update(installWizard);
	}
	 ...
	 */
	@Override
	public InstallWizard createInstallWizard(long installWizardId) {
		return installWizardPersistence.create(installWizardId);
	}
	...
	@Override
	public InstallWizard deleteInstallWizard(long installWizardId)
		throws PortalException, SystemException {
		return installWizardPersistence.remove(installWizardId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InstallWizard deleteInstallWizard(InstallWizard installWizard)
		throws SystemException {
		return installWizardPersistence.remove(installWizard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InstallWizard.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return installWizardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return installWizardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InstallWizard fetchInstallWizard(long installWizardId)
		throws SystemException {
		return installWizardPersistence.fetchByPrimaryKey(installWizardId);
	}
	 ...
	 */
	@Override
	public InstallWizard getInstallWizard(long installWizardId)
		throws PortalException, SystemException {
		return installWizardPersistence.findByPrimaryKey(installWizardId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return installWizardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InstallWizard> getInstallWizards(int start, int end)
		throws SystemException {
		return installWizardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getInstallWizardsCount() throws SystemException {
		return installWizardPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InstallWizard updateInstallWizard(InstallWizard installWizard)
		throws SystemException {
		return installWizardPersistence.update(installWizard);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.InstallWizard",
			installWizardLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = installWizardPersistence.getDataSource();
	...
	private InstallWizardLocalServiceClpInvoker _clpInvoker = new InstallWizardLocalServiceClpInvoker();
}

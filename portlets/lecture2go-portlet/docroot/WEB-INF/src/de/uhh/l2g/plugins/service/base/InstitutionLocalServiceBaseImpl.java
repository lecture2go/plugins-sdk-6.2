...
public abstract class InstitutionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InstitutionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.InstitutionLocalServiceUtil} to access the institution local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Institution.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return institutionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	 ...
	 */
	@Override
	public int getInstitutionsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Institution",
	...
	private InstitutionLocalServiceClpInvoker _clpInvoker = new InstitutionLocalServiceClpInvoker();
}

...
public abstract class Lectureseries_InstitutionLocalServiceBaseImpl
	...
	implements Lectureseries_InstitutionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Lectureseries_InstitutionLocalServiceUtil} to access the lectureseries_ institution local service.
	 */
	...
	public Lectureseries_Institution addLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.update(lectureseries_Institution);
	}
	...
	public Lectureseries_Institution createLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.create(lectureseriesInstitutionId);
	}
	...
	public Lectureseries_Institution deleteLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.remove(lectureseriesInstitutionId);
	}
	...
	public Lectureseries_Institution deleteLectureseries_Institution(
		Lectureseries_Institution lectureseries_Institution)
		throws SystemException {
		return lectureseries_InstitutionPersistence.remove(lectureseries_Institution);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Lectureseries_Institution.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return lectureseries_InstitutionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lectureseries_InstitutionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Lectureseries_Institution fetchLectureseries_Institution(
		...
		return lectureseries_InstitutionPersistence.fetchByPrimaryKey(lectureseriesInstitutionId);
	}
	...
	public Lectureseries_Institution getLectureseries_Institution(
		long lectureseriesInstitutionId)
		throws PortalException, SystemException {
		return lectureseries_InstitutionPersistence.findByPrimaryKey(lectureseriesInstitutionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lectureseries_InstitutionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public int getLectureseries_InstitutionsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Lectureseries_Institution",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lectureseries_InstitutionPersistence.getDataSource();
	...
	private Lectureseries_InstitutionLocalServiceClpInvoker _clpInvoker = new Lectureseries_InstitutionLocalServiceClpInvoker();
}

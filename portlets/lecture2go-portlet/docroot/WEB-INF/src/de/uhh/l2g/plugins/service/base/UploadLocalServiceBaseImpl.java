...
/**
 * Provides the base implementation for the upload local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.UploadLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class UploadLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UploadLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.UploadLocalServiceUtil} to access the upload local service.
	 */
	...
	@Override
	public Upload addUpload(Upload upload) throws SystemException {
		upload.setNew(true);

		return uploadPersistence.update(upload);
	}
	 ...
	 */
	@Override
	public Upload createUpload(long uploadId) {
		return uploadPersistence.create(uploadId);
	}
	...
	@Override
	public Upload deleteUpload(long uploadId)
		throws PortalException, SystemException {
		return uploadPersistence.remove(uploadId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Upload deleteUpload(Upload upload) throws SystemException {
		return uploadPersistence.remove(upload);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Upload.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return uploadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return uploadPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return uploadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return uploadPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Upload fetchUpload(long uploadId) throws SystemException {
		return uploadPersistence.fetchByPrimaryKey(uploadId);
	}
	...
	public Upload getUpload(long uploadId)
		throws PortalException, SystemException {
		return uploadPersistence.findByPrimaryKey(uploadId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return uploadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Upload> getUploads(int start, int end)
		throws SystemException {
		return uploadPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUploadsCount() throws SystemException {
		return uploadPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Upload updateUpload(Upload upload) throws SystemException {
		return uploadPersistence.update(upload);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Upload",
			uploadLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"de.uhh.l2g.plugins.model.Upload");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = uploadPersistence.getDataSource();
	...
	private UploadLocalServiceClpInvoker _clpInvoker = new UploadLocalServiceClpInvoker();
}
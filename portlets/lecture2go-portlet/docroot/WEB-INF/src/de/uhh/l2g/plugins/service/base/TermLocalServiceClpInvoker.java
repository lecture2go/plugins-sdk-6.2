...
public class TermLocalServiceClpInvoker {
	public TermLocalServiceClpInvoker() {
		...
		_methodName182 = "addTerm";

		_methodParameterTypes182 = new String[] { "de.uhh.l2g.plugins.model.Term" };

		_methodName183 = "getAllSemesters";

		_methodParameterTypes183 = new String[] {  };

		_methodName184 = "getById";

		_methodParameterTypes184 = new String[] { "java.lang.Long" };

		_methodName185 = "getTermsFromLectureseriesIdsAndVideoIds";

		_methodParameterTypes185 = new String[] {
				"java.util.ArrayList", "java.util.ArrayList"
			};

		_methodName186 = "deleteById";

		_methodParameterTypes186 = new String[] { "java.lang.Long" };

		_methodName187 = "getByPrefixAndYear";

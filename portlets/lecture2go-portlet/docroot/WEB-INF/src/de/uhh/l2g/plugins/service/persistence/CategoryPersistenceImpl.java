...
import de.uhh.l2g.plugins.NoSuchCategoryException;
...
public class CategoryPersistenceImpl extends BasePersistenceImpl<Category>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME = new FinderPath(CategoryModelImpl.ENTITY_CACHE_ENABLED,
			CategoryModelImpl.FINDER_CACHE_ENABLED, CategoryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NAME = new FinderPath(CategoryModelImpl.ENTITY_CACHE_ENABLED,
			CategoryModelImpl.FINDER_CACHE_ENABLED, CategoryImpl.class,
	 ...
	 */
	@Override
	public List<Category> findByName(String name) throws SystemException {
	...
	public List<Category> findByName(String name, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Category category : list) {
				if (!Validator.equals(name, category.getName())) {
					list = null;
	 ...
	 */
	@Override
	public Category findByName_First(String name,
	 ...
	 */
	@Override
	public Category fetchByName_First(String name,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Category findByName_Last(String name,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
	 ...
	 */
	@Override
	public Category fetchByName_Last(String name,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Category> list = findByName(name, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Category[] findByName_PrevAndNext(long categoryId, String name,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		...
		try {
			...
			array[0] = getByName_PrevAndNext(session, category, name,
					orderByComparator, true);

			array[1] = category;

			array[2] = getByName_PrevAndNext(session, category, name,
	...
	protected Category getByName_PrevAndNext(Session session,
	...
	public void removeByName(String name) throws SystemException {
		for (Category category : findByName(name, QueryUtil.ALL_POS,
	...
	@Override
	public Category updateImpl(de.uhh.l2g.plugins.model.Category category)
		throws SystemException {
		category = toUnwrappedModel(category);
	...
	protected Category toUnwrappedModel(Category category) {
		...
		categoryImpl.setParentId(category.getParentId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.de.uhh.l2g.plugins.model.Category")));

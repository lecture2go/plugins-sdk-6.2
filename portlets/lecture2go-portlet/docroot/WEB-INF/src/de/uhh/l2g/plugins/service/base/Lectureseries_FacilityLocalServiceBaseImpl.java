...
import de.uhh.l2g.plugins.service.Lectureseries_FacilityLocalService;
...
/**
 * Provides the base implementation for the lectureseries_ facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.service.impl.Lectureseries_FacilityLocalServiceImpl}.
 * </p>
 *
 * @author Iavor Sturm
 ...
 * @generated
 */
public abstract class Lectureseries_FacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Lectureseries_FacilityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.service.Lectureseries_FacilityLocalServiceUtil} to access the lectureseries_ facility local service.
	 */
	...
	@Override
	public Lectureseries_Facility addLectureseries_Facility(
		Lectureseries_Facility lectureseries_Facility)
		throws SystemException {
		lectureseries_Facility.setNew(true);

		return lectureseries_FacilityPersistence.update(lectureseries_Facility);
	}
	 ...
	 */
	@Override
	public Lectureseries_Facility createLectureseries_Facility(
		long lectureseriesFacilityId) {
		return lectureseries_FacilityPersistence.create(lectureseriesFacilityId);
	}
	...
	@Override
	public Lectureseries_Facility deleteLectureseries_Facility(
		long lectureseriesFacilityId) throws PortalException, SystemException {
		return lectureseries_FacilityPersistence.remove(lectureseriesFacilityId);
	}
	...
	public Lectureseries_Facility deleteLectureseries_Facility(
		Lectureseries_Facility lectureseries_Facility)
		throws SystemException {
		return lectureseries_FacilityPersistence.remove(lectureseries_Facility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Lectureseries_Facility.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return lectureseries_FacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lectureseries_FacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Lectureseries_Facility fetchLectureseries_Facility(
		long lectureseriesFacilityId) throws SystemException {
		return lectureseries_FacilityPersistence.fetchByPrimaryKey(lectureseriesFacilityId);
	}
	 ...
	 */
	@Override
	public Lectureseries_Facility getLectureseries_Facility(
		long lectureseriesFacilityId) throws PortalException, SystemException {
		return lectureseries_FacilityPersistence.findByPrimaryKey(lectureseriesFacilityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lectureseries_FacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Lectureseries_Facility> getLectureseries_Facilities(int start,
		int end) throws SystemException {
		return lectureseries_FacilityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLectureseries_FacilitiesCount() throws SystemException {
		return lectureseries_FacilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Lectureseries_Facility updateLectureseries_Facility(
		Lectureseries_Facility lectureseries_Facility)
		throws SystemException {
		return lectureseries_FacilityPersistence.update(lectureseries_Facility);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.model.Lectureseries_Facility",
			lectureseries_FacilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lectureseries_FacilityPersistence.getDataSource();
	...
	private Lectureseries_FacilityLocalServiceClpInvoker _clpInvoker = new Lectureseries_FacilityLocalServiceClpInvoker();
}
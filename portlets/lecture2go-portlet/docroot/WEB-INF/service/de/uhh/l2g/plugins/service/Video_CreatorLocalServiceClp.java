 ...
 * @generated
 */
public class Video_CreatorLocalServiceClp implements Video_CreatorLocalService {
	public Video_CreatorLocalServiceClp(
		...
		_methodName20 = "deleteByCreatorId";

		_methodParameterTypes20 = new String[] { "java.lang.Long" };

		_methodName21 = "getByVideoCreator";
	...
	public de.uhh.l2g.plugins.model.Video_Creator addVideo_Creator(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(video_Creator) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Video_Creator)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.Video_Creator createVideo_Creator(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { videoCreatorId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Video_Creator deleteVideo_Creator(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { videoCreatorId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Video_Creator fetchVideo_Creator(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { videoCreatorId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Video_Creator getVideo_Creator(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { videoCreatorId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.uhh.l2g.plugins.model.Video_Creator> getVideo_Creators(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Video_Creator>)ClpSerializer.translateOutput(returnObj);
	}

 ...
 * @generated
 */
public class Lectureseries_CategoryLocalServiceClp
	implements Lectureseries_CategoryLocalService {
	public Lectureseries_CategoryLocalServiceClp(
		...
		_methodName19 = "updateCategoryByLectureseriesAndCategory";
	...
	public de.uhh.l2g.plugins.model.Lectureseries_Category addLectureseries_Category(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(lectureseries_Category)
					});
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Lectureseries_Category)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.Lectureseries_Category createLectureseries_Category(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { lectureseriesCategoryId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.uhh.l2g.plugins.model.Lectureseries_Category> getLectureseries_Categories(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Lectureseries_Category>)ClpSerializer.translateOutput(returnObj);
	}

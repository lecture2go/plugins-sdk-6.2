...
/**
 * Provides the local service interface for Segment_User_Video. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see Segment_User_VideoLocalServiceUtil
...
public interface Segment_User_VideoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Segment_User_VideoLocalServiceUtil} to access the segment_ user_ video local service. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.Segment_User_VideoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

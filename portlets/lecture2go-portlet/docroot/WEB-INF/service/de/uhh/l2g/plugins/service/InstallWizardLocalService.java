...
/**
 * Provides the local service interface for InstallWizard. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see InstallWizardLocalServiceUtil
...
public interface InstallWizardLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InstallWizardLocalServiceUtil} to access the install wizard local service. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.InstallWizardLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

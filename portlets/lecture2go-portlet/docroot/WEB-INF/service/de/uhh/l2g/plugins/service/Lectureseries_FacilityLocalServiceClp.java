 ...
 * @generated
 */
public class Lectureseries_FacilityLocalServiceClp
	implements Lectureseries_FacilityLocalService {
	public Lectureseries_FacilityLocalServiceClp(
		...
		_methodName20 = "removeByacilityId";
	...
	public de.uhh.l2g.plugins.model.Lectureseries_Facility addLectureseries_Facility(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(lectureseries_Facility)
					});
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Lectureseries_Facility)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.model.Lectureseries_Facility> getLectureseries_Facilities(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Lectureseries_Facility>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public boolean facilityAssignedToLectureseries(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { ClpSerializer.translateInput(lf) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

...
public class ProducerLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<de.uhh.l2g.plugins.model.Producer> getAllProducers()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getAllProducers();
	}
	...
	public static ProducerLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ProducerLocalService.class.getName());

			if (invokableLocalService instanceof ProducerLocalService) {
				_service = (ProducerLocalService)invokableLocalService;
			}
			else {
				_service = new ProducerLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ProducerLocalServiceUtil.class,
				"_service");
		}
	...
	private static ProducerLocalService _service;
}
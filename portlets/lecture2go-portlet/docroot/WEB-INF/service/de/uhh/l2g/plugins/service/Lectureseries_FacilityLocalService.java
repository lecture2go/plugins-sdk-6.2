...
/**
 * Provides the local service interface for Lectureseries_Facility. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see Lectureseries_FacilityLocalServiceUtil
...
public interface Lectureseries_FacilityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Lectureseries_FacilityLocalServiceUtil} to access the lectureseries_ facility local service. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.Lectureseries_FacilityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

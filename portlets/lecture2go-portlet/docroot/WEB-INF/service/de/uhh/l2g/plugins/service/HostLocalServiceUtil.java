 ...
 * {@link de.uhh.l2g.plugins.service.impl.HostLocalServiceImpl} and is the
...
public class HostLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.HostLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static de.uhh.l2g.plugins.model.Host addHost(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addHost(userId, name, streamer, serverTemplate, protocol,
	...
	public static HostLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof HostLocalService) {
				_service = (HostLocalService)invokableLocalService;
			}
			else {
				_service = new HostLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(HostLocalServiceUtil.class,
				"_service");
		}

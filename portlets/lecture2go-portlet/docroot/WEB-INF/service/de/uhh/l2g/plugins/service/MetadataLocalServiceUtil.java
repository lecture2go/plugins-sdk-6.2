 ...
 * {@link de.uhh.l2g.plugins.service.impl.MetadataLocalServiceImpl} and is the
 ...
 * @see de.uhh.l2g.plugins.service.base.MetadataLocalServiceBaseImpl
...
public class MetadataLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.MetadataLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.uhh.l2g.plugins.model.Metadata> getMetadatas(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static MetadataLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					MetadataLocalService.class.getName());

			if (invokableLocalService instanceof MetadataLocalService) {
				_service = (MetadataLocalService)invokableLocalService;
			}
			else {
				_service = new MetadataLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(MetadataLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(MetadataLocalService service) {
	}

	private static MetadataLocalService _service;
}
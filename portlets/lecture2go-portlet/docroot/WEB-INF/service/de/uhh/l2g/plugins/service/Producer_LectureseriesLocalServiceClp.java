 ...
 * @generated
 */
public class Producer_LectureseriesLocalServiceClp
	implements Producer_LectureseriesLocalService {
	public Producer_LectureseriesLocalServiceClp(
	...
	public de.uhh.l2g.plugins.model.Producer_Lectureseries addProducer_Lectureseries(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(producer_Lectureseries)
					});
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Producer_Lectureseries)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.model.Producer_Lectureseries> getProducer_Lectureserieses(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Producer_Lectureseries>)ClpSerializer.translateOutput(returnObj);
	}

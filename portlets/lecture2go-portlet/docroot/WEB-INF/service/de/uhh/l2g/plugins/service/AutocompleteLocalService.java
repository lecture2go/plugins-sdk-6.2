...
/**
 * Provides the local service interface for Autocomplete. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Iavor Sturm
 * @see AutocompleteLocalServiceUtil
...
public interface AutocompleteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AutocompleteLocalServiceUtil} to access the autocomplete local service. Add custom service methods to {@link de.uhh.l2g.plugins.service.impl.AutocompleteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

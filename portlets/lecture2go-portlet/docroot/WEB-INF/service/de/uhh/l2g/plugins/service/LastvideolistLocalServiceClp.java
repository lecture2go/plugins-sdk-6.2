 ...
 * @generated
 */
public class LastvideolistLocalServiceClp implements LastvideolistLocalService {
	public LastvideolistLocalServiceClp(
	...
	public de.uhh.l2g.plugins.model.Lastvideolist addLastvideolist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(lastvideolist) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Lastvideolist)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.Lastvideolist createLastvideolist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { lastvideolistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Lastvideolist deleteLastvideolist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { lastvideolistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Lastvideolist fetchLastvideolist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { lastvideolistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Lastvideolist getLastvideolist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { lastvideolistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	@Override
	public java.util.List<de.uhh.l2g.plugins.model.Lastvideolist> getLastvideolists(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Lastvideolist>)ClpSerializer.translateOutput(returnObj);
	}

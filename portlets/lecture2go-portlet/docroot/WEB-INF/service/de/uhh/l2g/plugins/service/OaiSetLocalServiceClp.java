 ...
 * @generated
 */
public class OaiSetLocalServiceClp implements OaiSetLocalService {
	public OaiSetLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getAll";

		_methodParameterTypes19 = new String[] {  };

		_methodName20 = "getByOaiRecordId";
	...
	public de.uhh.l2g.plugins.model.OaiSet addOaiSet(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(oaiSet) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.OaiSet)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.OaiSet createOaiSet(long oaiSetId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { oaiSetId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.OaiSet deleteOaiSet(long oaiSetId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { oaiSetId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.OaiSet fetchOaiSet(long oaiSetId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { oaiSetId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.OaiSet getOaiSet(long oaiSetId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { oaiSetId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.uhh.l2g.plugins.model.OaiSet> getOaiSets(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.OaiSet>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.model.OaiSet> getByOaiRecordId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					_methodParameterTypes20, new Object[] { oaiRecordId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

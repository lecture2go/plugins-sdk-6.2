...
public class CreatorFinderUtil {
	...
	public static java.util.List<de.uhh.l2g.plugins.model.Creator> findCreatorsByVideo(
		long videoId) {
		return getFinder().findCreatorsByVideo(videoId);
	}

	public static java.util.List<de.uhh.l2g.plugins.model.Creator> findCreatorsForLectureseriesOverTheAssigenedVideos(
		long lectureseriesId) {
		return getFinder()
				   .findCreatorsForLectureseriesOverTheAssigenedVideos(lectureseriesId);
	}

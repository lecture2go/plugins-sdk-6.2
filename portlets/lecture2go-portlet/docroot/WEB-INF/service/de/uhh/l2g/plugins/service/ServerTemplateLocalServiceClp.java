 ...
 * @generated
 */
public class ServerTemplateLocalServiceClp implements ServerTemplateLocalService {
	public ServerTemplateLocalServiceClp(
		...
		_methodName21 = "getDeviceSpecificByServerTemplateId";

		_methodParameterTypes21 = new String[] { "long" };

		_methodName22 = "addServerTemplate";
	...
	public de.uhh.l2g.plugins.model.ServerTemplate addServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(serverTemplate) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.ServerTemplate)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.ServerTemplate createServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { serverTemplateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.ServerTemplate deleteServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { serverTemplateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.ServerTemplate fetchServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { serverTemplateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.ServerTemplate getServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { serverTemplateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.uhh.l2g.plugins.model.ServerTemplate> getServerTemplates(
		...
		return (java.util.List<de.uhh.l2g.plugins.model.ServerTemplate>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public boolean getDeviceSpecificByServerTemplateId(long serverTemplateId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					_methodParameterTypes21, new Object[] { serverTemplateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.ServerTemplate addServerTemplate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					...
					ClpSerializer.translateInput(templateURL),
						
					ClpSerializer.translateInput(prefixURL),
						
					ClpSerializer.translateInput(suffixURL),
						
					ClpSerializer.translateInput(secExt),

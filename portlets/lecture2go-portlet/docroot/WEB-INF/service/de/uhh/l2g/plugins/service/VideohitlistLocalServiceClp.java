 ...
 * @generated
 */
public class VideohitlistLocalServiceClp implements VideohitlistLocalService {
	public VideohitlistLocalServiceClp(
	...
	public de.uhh.l2g.plugins.model.Videohitlist addVideohitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(videohitlist) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.model.Videohitlist)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.uhh.l2g.plugins.model.Videohitlist createVideohitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { videohitlistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Videohitlist deleteVideohitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { videohitlistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Videohitlist fetchVideohitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { videohitlistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.uhh.l2g.plugins.model.Videohitlist getVideohitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { videohitlistId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	@Override
	public java.util.List<de.uhh.l2g.plugins.model.Videohitlist> getVideohitlists(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		Object returnObj = null;
		...
		return (java.util.List<de.uhh.l2g.plugins.model.Videohitlist>)ClpSerializer.translateOutput(returnObj);
	}

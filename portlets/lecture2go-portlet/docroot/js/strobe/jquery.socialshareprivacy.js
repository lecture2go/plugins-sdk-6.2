    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/lecture2go-theme/images/socialshareprivacy/dummy_facebook.png',
                ...
                'twitter' : {
                    'status'            : 'on', 
                    'dummy_img'         : '/lecture2go-theme/images/socialshareprivacy/dummy_twitter.png',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/lecture2go-theme/images/socialshareprivacy/dummy_gplus.png',
            ...
            'cookie_expires'    : '365',
            'css_path'          : '/lecture2go-theme/css/socialshareprivacy.css',
            'uri'               : getURI
        };

 ...
 * @generated
 */
public abstract class LegacyFacilityHostActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public LegacyFacilityHostActionableDynamicQuery() throws SystemException {
		setBaseLocalService(LegacyFacilityHostLocalServiceUtil.getService());
		setClass(LegacyFacilityHost.class);

		setClassLoader(de.uhh.l2g.plugins.migration.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("facilityHostId");
	}
}
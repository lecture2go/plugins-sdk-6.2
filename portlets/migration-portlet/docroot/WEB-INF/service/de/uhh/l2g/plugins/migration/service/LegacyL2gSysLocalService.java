...
/**
 * Provides the local service interface for LegacyL2gSys. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author unihh
 * @see LegacyL2gSysLocalServiceUtil
...
public interface LegacyL2gSysLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegacyL2gSysLocalServiceUtil} to access the legacy l2g sys local service. Add custom service methods to {@link de.uhh.l2g.plugins.migration.service.impl.LegacyL2gSysLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

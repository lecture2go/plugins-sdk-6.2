...
/**
 * The persistence utility for the legacy video hitlist service. This utility wraps {@link LegacyVideoHitlistPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LegacyVideoHitlistPersistenceImpl
 * @generated
 */
public class LegacyVideoHitlistUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(LegacyVideoHitlist legacyVideoHitlist) {
		getPersistence().clearCache(legacyVideoHitlist);
	}
	 ...
	 */
	public static List<LegacyVideoHitlist> findWithDynamicQuery(
	 ...
	 */
	public static LegacyVideoHitlist update(
		LegacyVideoHitlist legacyVideoHitlist) throws SystemException {
		return getPersistence().update(legacyVideoHitlist);
	}
	 ...
	 */
	public static LegacyVideoHitlist update(
		LegacyVideoHitlist legacyVideoHitlist, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(legacyVideoHitlist, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacyVideoHitlist);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist> legacyVideoHitlists) {
		getPersistence().cacheResult(legacyVideoHitlists);
	}
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist create(
		long id) {
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist remove(
		long id)
	...
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist updateImpl(
		de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist legacyVideoHitlist)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(legacyVideoHitlist);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.uhh.l2g.plugins.migration.NoSuchLegacyVideoHitlistException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LegacyVideoHitlistPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LegacyVideoHitlistPersistence)PortletBeanLocatorUtil.locate(de.uhh.l2g.plugins.migration.service.ClpSerializer.getServletContextName(),
					LegacyVideoHitlistPersistence.class.getName());

			ReferenceRegistry.registerReference(LegacyVideoHitlistUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LegacyVideoHitlistPersistence persistence) {
	}

	private static LegacyVideoHitlistPersistence _persistence;
}
 ...
 * @generated
 */
public class LegacyLectureSeriesLocalServiceClp
	implements LegacyLectureSeriesLocalService {
	public LegacyLectureSeriesLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyLectureSeries addLegacyLectureSeries(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(legacyLectureSeries)
					});
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyLectureSeries)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyLectureSeries> getLegacyLectureSerieses(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyLectureSeries>)ClpSerializer.translateOutput(returnObj);
	}

 ...
 * @generated
 */
public class LegacyProducerLectureseriesLocalServiceClp
	implements LegacyProducerLectureseriesLocalService {
	public LegacyProducerLectureseriesLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyProducerLectureseries addLegacyProducerLectureseries(
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyProducerLectureseries)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyProducerLectureseries> getLegacyProducerLectureserieses(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyProducerLectureseries>)ClpSerializer.translateOutput(returnObj);
	}

...
/**
 * The persistence utility for the legacy segment service. This utility wraps {@link LegacySegmentPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class LegacySegmentUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(LegacySegment legacySegment) {
		getPersistence().clearCache(legacySegment);
	}
	 ...
	 */
	public static List<LegacySegment> findWithDynamicQuery(
	 ...
	 */
	public static LegacySegment update(LegacySegment legacySegment)
		throws SystemException {
		return getPersistence().update(legacySegment);
	}
	...
	public static LegacySegment update(LegacySegment legacySegment,
		...
		return getPersistence().update(legacySegment, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacySegment);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacySegments);
	}
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacySegment create(
		long id) {
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacySegment remove(
		long id)
	...
	public static de.uhh.l2g.plugins.migration.model.LegacySegment updateImpl(
		de.uhh.l2g.plugins.migration.model.LegacySegment legacySegment)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(legacySegment);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacySegment findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.uhh.l2g.plugins.migration.NoSuchLegacySegmentException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacySegment fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.uhh.l2g.plugins.migration.model.LegacySegment> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LegacySegmentPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LegacySegmentPersistence)PortletBeanLocatorUtil.locate(de.uhh.l2g.plugins.migration.service.ClpSerializer.getServletContextName(),
					LegacySegmentPersistence.class.getName());

			ReferenceRegistry.registerReference(LegacySegmentUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LegacySegmentPersistence persistence) {
	}

	private static LegacySegmentPersistence _persistence;
}
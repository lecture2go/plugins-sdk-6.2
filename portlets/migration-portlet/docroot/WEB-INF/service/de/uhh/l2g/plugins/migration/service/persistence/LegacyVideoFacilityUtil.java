...
/**
 * The persistence utility for the legacy video facility service. This utility wraps {@link LegacyVideoFacilityPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LegacyVideoFacilityPersistenceImpl
 * @generated
 */
public class LegacyVideoFacilityUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(LegacyVideoFacility legacyVideoFacility) {
		getPersistence().clearCache(legacyVideoFacility);
	}
	 ...
	 */
	public static List<LegacyVideoFacility> findWithDynamicQuery(
	 ...
	 */
	public static LegacyVideoFacility update(
		LegacyVideoFacility legacyVideoFacility) throws SystemException {
		return getPersistence().update(legacyVideoFacility);
	}
	 ...
	 */
	public static LegacyVideoFacility update(
		LegacyVideoFacility legacyVideoFacility, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(legacyVideoFacility, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacyVideoFacility);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoFacility> legacyVideoFacilities) {
		getPersistence().cacheResult(legacyVideoFacilities);
	}
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoFacility create(
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoFacility remove(
		long videoFacilityId)
	...
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoFacility updateImpl(
		de.uhh.l2g.plugins.migration.model.LegacyVideoFacility legacyVideoFacility)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(legacyVideoFacility);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoFacility findByPrimaryKey(
		long videoFacilityId)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.uhh.l2g.plugins.migration.NoSuchLegacyVideoFacilityException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyVideoFacility fetchByPrimaryKey(
		long videoFacilityId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoFacility> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LegacyVideoFacilityPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LegacyVideoFacilityPersistence)PortletBeanLocatorUtil.locate(de.uhh.l2g.plugins.migration.service.ClpSerializer.getServletContextName(),
					LegacyVideoFacilityPersistence.class.getName());

			ReferenceRegistry.registerReference(LegacyVideoFacilityUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LegacyVideoFacilityPersistence persistence) {
	}

	private static LegacyVideoFacilityPersistence _persistence;
}
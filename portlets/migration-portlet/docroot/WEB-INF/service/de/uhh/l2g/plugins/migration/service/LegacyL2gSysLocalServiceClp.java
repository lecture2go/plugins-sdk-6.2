 ...
 * @generated
 */
public class LegacyL2gSysLocalServiceClp implements LegacyL2gSysLocalService {
	public LegacyL2gSysLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyL2gSys addLegacyL2gSys(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(legacyL2gSys) });
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyL2gSys)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyL2gSys> getLegacyL2gSyses(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyL2gSys>)ClpSerializer.translateOutput(returnObj);
	}

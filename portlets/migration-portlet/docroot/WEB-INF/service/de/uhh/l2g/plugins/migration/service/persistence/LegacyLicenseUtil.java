...
/**
 * The persistence utility for the legacy license service. This utility wraps {@link LegacyLicensePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class LegacyLicenseUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(LegacyLicense legacyLicense) {
		getPersistence().clearCache(legacyLicense);
	}
	 ...
	 */
	public static List<LegacyLicense> findWithDynamicQuery(
	 ...
	 */
	public static LegacyLicense update(LegacyLicense legacyLicense)
		throws SystemException {
		return getPersistence().update(legacyLicense);
	}
	...
	public static LegacyLicense update(LegacyLicense legacyLicense,
		...
		return getPersistence().update(legacyLicense, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacyLicense);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(legacyLicenses);
	}
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyLicense create(
		long id) {
	...
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyLicense remove(
		long id)
	...
	public static de.uhh.l2g.plugins.migration.model.LegacyLicense updateImpl(
		de.uhh.l2g.plugins.migration.model.LegacyLicense legacyLicense)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(legacyLicense);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyLicense findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.uhh.l2g.plugins.migration.NoSuchLegacyLicenseException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.uhh.l2g.plugins.migration.model.LegacyLicense fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.uhh.l2g.plugins.migration.model.LegacyLicense> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LegacyLicensePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LegacyLicensePersistence)PortletBeanLocatorUtil.locate(de.uhh.l2g.plugins.migration.service.ClpSerializer.getServletContextName(),
					LegacyLicensePersistence.class.getName());

			ReferenceRegistry.registerReference(LegacyLicenseUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LegacyLicensePersistence persistence) {
	}

	private static LegacyLicensePersistence _persistence;
}
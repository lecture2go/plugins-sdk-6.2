 ...
 * @generated
 */
public class LegacyCoordinatorLocalServiceClp
	implements LegacyCoordinatorLocalService {
	public LegacyCoordinatorLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyCoordinator addLegacyCoordinator(
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyCoordinator)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyCoordinator> getLegacyCoordinators(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyCoordinator>)ClpSerializer.translateOutput(returnObj);
	}

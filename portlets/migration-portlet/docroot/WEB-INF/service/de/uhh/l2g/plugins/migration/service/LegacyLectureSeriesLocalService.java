...
/**
 * Provides the local service interface for LegacyLectureSeries. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author unihh
 * @see LegacyLectureSeriesLocalServiceUtil
...
public interface LegacyLectureSeriesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegacyLectureSeriesLocalServiceUtil} to access the legacy lecture series local service. Add custom service methods to {@link de.uhh.l2g.plugins.migration.service.impl.LegacyLectureSeriesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

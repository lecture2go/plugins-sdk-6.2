...
/**
 * Provides the local service interface for TestEntityTwo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author unihh
 * @see TestEntityTwoLocalServiceUtil
...
public interface TestEntityTwoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestEntityTwoLocalServiceUtil} to access the test entity two local service. Add custom service methods to {@link de.uhh.l2g.plugins.migration.service.impl.TestEntityTwoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

 ...
 * @generated
 */
public class LegacyVideoHitlistLocalServiceClp
	implements LegacyVideoHitlistLocalService {
	public LegacyVideoHitlistLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist addLegacyVideoHitlist(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(legacyVideoHitlist)
					});
		}
		catch (Throwable t) {
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist> getLegacyVideoHitlists(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist>)ClpSerializer.translateOutput(returnObj);
	}

 ...
 * @generated
 */
public class LegacyLectureSeriesFacilityLocalServiceClp
	implements LegacyLectureSeriesFacilityLocalService {
	public LegacyLectureSeriesFacilityLocalServiceClp(
	...
	public de.uhh.l2g.plugins.migration.model.LegacyLectureSeriesFacility addLegacyLectureSeriesFacility(
		...
		return (de.uhh.l2g.plugins.migration.model.LegacyLectureSeriesFacility)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<de.uhh.l2g.plugins.migration.model.LegacyLectureSeriesFacility> getLegacyLectureSeriesFacilities(
		...
		return (java.util.List<de.uhh.l2g.plugins.migration.model.LegacyLectureSeriesFacility>)ClpSerializer.translateOutput(returnObj);
	}

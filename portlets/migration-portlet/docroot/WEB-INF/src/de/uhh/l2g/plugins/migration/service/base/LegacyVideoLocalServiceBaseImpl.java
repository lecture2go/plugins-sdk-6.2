...
import de.uhh.l2g.plugins.migration.service.LegacyVideoLocalService;
...
/**
 * Provides the base implementation for the legacy video local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyVideoLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyVideoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyVideoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyVideoLocalServiceUtil} to access the legacy video local service.
	 */
	...
	@Override
	public LegacyVideo addLegacyVideo(LegacyVideo legacyVideo)
		throws SystemException {
		legacyVideo.setNew(true);

		return legacyVideoPersistence.update(legacyVideo);
	}
	 ...
	 */
	@Override
	public LegacyVideo createLegacyVideo(long id) {
		return legacyVideoPersistence.create(id);
	}
	...
	@Override
	public LegacyVideo deleteLegacyVideo(long id)
		throws PortalException, SystemException {
		return legacyVideoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyVideo deleteLegacyVideo(LegacyVideo legacyVideo)
		throws SystemException {
		return legacyVideoPersistence.remove(legacyVideo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyVideo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyVideoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return legacyVideoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyVideoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyVideo fetchLegacyVideo(long id) throws SystemException {
		return legacyVideoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyVideo getLegacyVideo(long id)
		throws PortalException, SystemException {
		return legacyVideoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyVideoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyVideo> getLegacyVideos(int start, int end)
		throws SystemException {
		return legacyVideoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyVideosCount() throws SystemException {
		return legacyVideoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyVideo updateLegacyVideo(LegacyVideo legacyVideo)
		throws SystemException {
		return legacyVideoPersistence.update(legacyVideo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyVideo",
			legacyVideoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyVideoPersistence.getDataSource();
	...
	private LegacyVideoLocalServiceClpInvoker _clpInvoker = new LegacyVideoLocalServiceClpInvoker();
}
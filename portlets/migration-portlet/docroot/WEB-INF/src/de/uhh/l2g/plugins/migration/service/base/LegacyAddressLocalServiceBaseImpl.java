...
import de.uhh.l2g.plugins.migration.service.LegacyAddressLocalService;
...
/**
 * Provides the base implementation for the legacy address local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyAddressLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyAddressLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyAddressLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyAddressLocalServiceUtil} to access the legacy address local service.
	 */
	...
	@Override
	public LegacyAddress addLegacyAddress(LegacyAddress legacyAddress)
		throws SystemException {
		legacyAddress.setNew(true);

		return legacyAddressPersistence.update(legacyAddress);
	}
	 ...
	 */
	@Override
	public LegacyAddress createLegacyAddress(long addressId) {
		return legacyAddressPersistence.create(addressId);
	}
	...
	@Override
	public LegacyAddress deleteLegacyAddress(long addressId)
		throws PortalException, SystemException {
		return legacyAddressPersistence.remove(addressId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyAddress deleteLegacyAddress(LegacyAddress legacyAddress)
		throws SystemException {
		return legacyAddressPersistence.remove(legacyAddress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyAddress.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyAddressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyAddressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyAddress fetchLegacyAddress(long addressId)
		throws SystemException {
		return legacyAddressPersistence.fetchByPrimaryKey(addressId);
	}
	 ...
	 */
	@Override
	public LegacyAddress getLegacyAddress(long addressId)
		throws PortalException, SystemException {
		return legacyAddressPersistence.findByPrimaryKey(addressId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyAddressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyAddress> getLegacyAddresses(int start, int end)
		throws SystemException {
		return legacyAddressPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyAddressesCount() throws SystemException {
		return legacyAddressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyAddress updateLegacyAddress(LegacyAddress legacyAddress)
		throws SystemException {
		return legacyAddressPersistence.update(legacyAddress);
	}
...
>>>>>>> refs/remotes/lecture2go/master
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyAddress",
			legacyAddressLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyAddressPersistence.getDataSource();
...
>>>>>>> refs/remotes/lecture2go/master
	...
	private LegacyAddressLocalServiceClpInvoker _clpInvoker = new LegacyAddressLocalServiceClpInvoker();
}

...
import de.uhh.l2g.plugins.migration.service.LegacyFacilityHostLocalService;
...
/**
 * Provides the base implementation for the legacy facility host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyFacilityHostLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyFacilityHostLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyFacilityHostLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyFacilityHostLocalServiceUtil} to access the legacy facility host local service.
	 */
	...
	@Override
	public LegacyFacilityHost addLegacyFacilityHost(
		LegacyFacilityHost legacyFacilityHost) throws SystemException {
		legacyFacilityHost.setNew(true);

		return legacyFacilityHostPersistence.update(legacyFacilityHost);
	}
	 ...
	 */
	@Override
	public LegacyFacilityHost createLegacyFacilityHost(long facilityHostId) {
		return legacyFacilityHostPersistence.create(facilityHostId);
	}
	...
	@Override
	public LegacyFacilityHost deleteLegacyFacilityHost(long facilityHostId)
		throws PortalException, SystemException {
		return legacyFacilityHostPersistence.remove(facilityHostId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyFacilityHost deleteLegacyFacilityHost(
		LegacyFacilityHost legacyFacilityHost) throws SystemException {
		return legacyFacilityHostPersistence.remove(legacyFacilityHost);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyFacilityHost.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyFacilityHostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyFacilityHostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyFacilityHost fetchLegacyFacilityHost(long facilityHostId)
		throws SystemException {
		return legacyFacilityHostPersistence.fetchByPrimaryKey(facilityHostId);
	}
	 ...
	 */
	@Override
	public LegacyFacilityHost getLegacyFacilityHost(long facilityHostId)
		throws PortalException, SystemException {
		return legacyFacilityHostPersistence.findByPrimaryKey(facilityHostId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyFacilityHostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyFacilityHost> getLegacyFacilityHosts(int start, int end)
		throws SystemException {
		return legacyFacilityHostPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyFacilityHostsCount() throws SystemException {
		return legacyFacilityHostPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyFacilityHost updateLegacyFacilityHost(
		LegacyFacilityHost legacyFacilityHost) throws SystemException {
		return legacyFacilityHostPersistence.update(legacyFacilityHost);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyFacilityHost",
			legacyFacilityHostLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyFacilityHostPersistence.getDataSource();
	...
	private LegacyFacilityHostLocalServiceClpInvoker _clpInvoker = new LegacyFacilityHostLocalServiceClpInvoker();
}
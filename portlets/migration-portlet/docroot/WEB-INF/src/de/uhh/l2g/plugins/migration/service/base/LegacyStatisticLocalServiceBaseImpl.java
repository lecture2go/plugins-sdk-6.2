...
import de.uhh.l2g.plugins.migration.service.LegacyStatisticLocalService;
...
/**
 * Provides the base implementation for the legacy statistic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyStatisticLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyStatisticLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyStatisticLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyStatisticLocalServiceUtil} to access the legacy statistic local service.
	 */
	...
	@Override
	public LegacyStatistic addLegacyStatistic(LegacyStatistic legacyStatistic)
		throws SystemException {
		legacyStatistic.setNew(true);

		return legacyStatisticPersistence.update(legacyStatistic);
	}
	 ...
	 */
	@Override
	public LegacyStatistic createLegacyStatistic(int id) {
		return legacyStatisticPersistence.create(id);
	}
	...
	@Override
	public LegacyStatistic deleteLegacyStatistic(int id)
		throws PortalException, SystemException {
		return legacyStatisticPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyStatistic deleteLegacyStatistic(
		LegacyStatistic legacyStatistic) throws SystemException {
		return legacyStatisticPersistence.remove(legacyStatistic);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyStatistic.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyStatisticPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyStatisticPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyStatistic fetchLegacyStatistic(int id)
		throws SystemException {
		return legacyStatisticPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyStatistic getLegacyStatistic(int id)
		throws PortalException, SystemException {
		return legacyStatisticPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyStatisticPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyStatistic> getLegacyStatistics(int start, int end)
		throws SystemException {
		return legacyStatisticPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyStatisticsCount() throws SystemException {
		return legacyStatisticPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyStatistic updateLegacyStatistic(
		LegacyStatistic legacyStatistic) throws SystemException {
		return legacyStatisticPersistence.update(legacyStatistic);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyStatistic",
			legacyStatisticLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyStatisticPersistence.getDataSource();
	...
	private LegacyStatisticLocalServiceClpInvoker _clpInvoker = new LegacyStatisticLocalServiceClpInvoker();
}
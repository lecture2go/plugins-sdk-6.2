...
import de.uhh.l2g.plugins.migration.service.TestEntityTwoLocalService;
...
/**
 * Provides the base implementation for the test entity two local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.TestEntityTwoLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 * @see de.uhh.l2g.plugins.migration.service.impl.TestEntityTwoLocalServiceImpl
 * @see de.uhh.l2g.plugins.migration.service.TestEntityTwoLocalServiceUtil
 * @generated
 */
public abstract class TestEntityTwoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TestEntityTwoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.TestEntityTwoLocalServiceUtil} to access the test entity two local service.
	 */
	...
	@Override
	public TestEntityTwo addTestEntityTwo(TestEntityTwo testEntityTwo)
		throws SystemException {
		testEntityTwo.setNew(true);

		return testEntityTwoPersistence.update(testEntityTwo);
	}
	 ...
	 */
	@Override
	public TestEntityTwo createTestEntityTwo(long plid) {
		return testEntityTwoPersistence.create(plid);
	}
	...
	@Override
	public TestEntityTwo deleteTestEntityTwo(long plid)
		throws PortalException, SystemException {
		return testEntityTwoPersistence.remove(plid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestEntityTwo deleteTestEntityTwo(TestEntityTwo testEntityTwo)
		throws SystemException {
		return testEntityTwoPersistence.remove(testEntityTwo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TestEntityTwo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return testEntityTwoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return testEntityTwoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TestEntityTwo fetchTestEntityTwo(long plid)
		throws SystemException {
		return testEntityTwoPersistence.fetchByPrimaryKey(plid);
	}
	 ...
	 */
	@Override
	public TestEntityTwo getTestEntityTwo(long plid)
		throws PortalException, SystemException {
		return testEntityTwoPersistence.findByPrimaryKey(plid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return testEntityTwoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestEntityTwo> getTestEntityTwos(int start, int end)
		throws SystemException {
		return testEntityTwoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTestEntityTwosCount() throws SystemException {
		return testEntityTwoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestEntityTwo updateTestEntityTwo(TestEntityTwo testEntityTwo)
		throws SystemException {
		return testEntityTwoPersistence.update(testEntityTwo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.TestEntityTwo",
			testEntityTwoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = testEntityTwoPersistence.getDataSource();
	...
	private TestEntityTwoLocalServiceClpInvoker _clpInvoker = new TestEntityTwoLocalServiceClpInvoker();
}
...
public class StatisticsMapper {
	...
	public static Upload mapUpload(LegacyStatistics legacyStatistics, Statistics statistics, long companyId) {
		if (legacyStatistics == null || statistics == null) {
			log.warn("can't execute method with null values - return statistics as null value");
			return null;
		}
		statistics.setContentLength(legacyStatistics.getContentLength());
		statistics.setStatus(legacyStatistics.getStatus());

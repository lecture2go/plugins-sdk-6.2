...
import de.uhh.l2g.plugins.migration.service.LegacyProducerLocalService;
...
/**
 * Provides the base implementation for the legacy producer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyProducerLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyProducerLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyProducerLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyProducerLocalServiceUtil} to access the legacy producer local service.
	 */
	...
	@Override
	public LegacyProducer addLegacyProducer(LegacyProducer legacyProducer)
		throws SystemException {
		legacyProducer.setNew(true);

		return legacyProducerPersistence.update(legacyProducer);
	}
	 ...
	 */
	@Override
	public LegacyProducer createLegacyProducer(long id) {
		return legacyProducerPersistence.create(id);
	}
	...
	@Override
	public LegacyProducer deleteLegacyProducer(long id)
		throws PortalException, SystemException {
		return legacyProducerPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyProducer deleteLegacyProducer(LegacyProducer legacyProducer)
		throws SystemException {
		return legacyProducerPersistence.remove(legacyProducer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyProducer.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyProducerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyProducerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyProducer fetchLegacyProducer(long id)
		throws SystemException {
		return legacyProducerPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyProducer getLegacyProducer(long id)
		throws PortalException, SystemException {
		return legacyProducerPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyProducerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyProducer> getLegacyProducers(int start, int end)
		throws SystemException {
		return legacyProducerPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyProducersCount() throws SystemException {
		return legacyProducerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyProducer updateLegacyProducer(LegacyProducer legacyProducer)
		throws SystemException {
		return legacyProducerPersistence.update(legacyProducer);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyProducer",
			legacyProducerLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyProducerPersistence.getDataSource();
	...
	private LegacyProducerLocalServiceClpInvoker _clpInvoker = new LegacyProducerLocalServiceClpInvoker();
}
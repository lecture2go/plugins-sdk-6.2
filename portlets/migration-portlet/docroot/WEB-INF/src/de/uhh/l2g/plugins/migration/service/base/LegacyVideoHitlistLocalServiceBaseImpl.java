...
import de.uhh.l2g.plugins.migration.service.LegacyVideoHitlistLocalService;
...
/**
 * Provides the base implementation for the legacy video hitlist local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyVideoHitlistLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyVideoHitlistLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyVideoHitlistLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyVideoHitlistLocalServiceUtil} to access the legacy video hitlist local service.
	 */
	...
	@Override
	public LegacyVideoHitlist addLegacyVideoHitlist(
		LegacyVideoHitlist legacyVideoHitlist) throws SystemException {
		legacyVideoHitlist.setNew(true);

		return legacyVideoHitlistPersistence.update(legacyVideoHitlist);
	}
	 ...
	 */
	@Override
	public LegacyVideoHitlist createLegacyVideoHitlist(long id) {
		return legacyVideoHitlistPersistence.create(id);
	}
	...
	@Override
	public LegacyVideoHitlist deleteLegacyVideoHitlist(long id)
		throws PortalException, SystemException {
		return legacyVideoHitlistPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyVideoHitlist deleteLegacyVideoHitlist(
		LegacyVideoHitlist legacyVideoHitlist) throws SystemException {
		return legacyVideoHitlistPersistence.remove(legacyVideoHitlist);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyVideoHitlist.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyVideoHitlistPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyVideoHitlistPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyVideoHitlist fetchLegacyVideoHitlist(long id)
		throws SystemException {
		return legacyVideoHitlistPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyVideoHitlist getLegacyVideoHitlist(long id)
		throws PortalException, SystemException {
		return legacyVideoHitlistPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyVideoHitlistPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyVideoHitlist> getLegacyVideoHitlists(int start, int end)
		throws SystemException {
		return legacyVideoHitlistPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyVideoHitlistsCount() throws SystemException {
		return legacyVideoHitlistPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyVideoHitlist updateLegacyVideoHitlist(
		LegacyVideoHitlist legacyVideoHitlist) throws SystemException {
		return legacyVideoHitlistPersistence.update(legacyVideoHitlist);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyVideoHitlist",
			legacyVideoHitlistLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyVideoHitlistPersistence.getDataSource();
	...
	private LegacyVideoHitlistLocalServiceClpInvoker _clpInvoker = new LegacyVideoHitlistLocalServiceClpInvoker();
}
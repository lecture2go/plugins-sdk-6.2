...
import de.uhh.l2g.plugins.migration.service.LegacyStatisticsLocalService;
...
/**
 * Provides the base implementation for the legacy statistics local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyStatisticsLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyStatisticsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyStatisticsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyStatisticsLocalServiceUtil} to access the legacy statistics local service.
	 */
	...
	@Override
	public LegacyStatistics addLegacyStatistics(
		LegacyStatistics legacyStatistics) throws SystemException {
		legacyStatistics.setNew(true);

		return legacyStatisticsPersistence.update(legacyStatistics);
	}
	 ...
	 */
	@Override
	public LegacyStatistics createLegacyStatistics(int id) {
		return legacyStatisticsPersistence.create(id);
	}
	...
	@Override
	public LegacyStatistics deleteLegacyStatistics(int id)
		throws PortalException, SystemException {
		return legacyStatisticsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyStatistics deleteLegacyStatistics(
		LegacyStatistics legacyStatistics) throws SystemException {
		return legacyStatisticsPersistence.remove(legacyStatistics);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyStatistics.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyStatisticsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyStatisticsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyStatistics fetchLegacyStatistics(int id)
		throws SystemException {
		return legacyStatisticsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyStatistics getLegacyStatistics(int id)
		throws PortalException, SystemException {
		return legacyStatisticsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyStatisticsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyStatistics> getLegacyStatisticses(int start, int end)
		throws SystemException {
		return legacyStatisticsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyStatisticsesCount() throws SystemException {
		return legacyStatisticsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyStatistics updateLegacyStatistics(
		LegacyStatistics legacyStatistics) throws SystemException {
		return legacyStatisticsPersistence.update(legacyStatistics);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyStatistics",
			legacyStatisticsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyStatisticsPersistence.getDataSource();
	...
	private LegacyStatisticsLocalServiceClpInvoker _clpInvoker = new LegacyStatisticsLocalServiceClpInvoker();
}
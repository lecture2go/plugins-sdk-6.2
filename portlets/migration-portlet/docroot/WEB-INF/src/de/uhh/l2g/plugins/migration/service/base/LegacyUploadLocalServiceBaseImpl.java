...
import de.uhh.l2g.plugins.migration.service.LegacyUploadLocalService;
...
/**
 * Provides the base implementation for the legacy upload local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyUploadLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyUploadLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyUploadLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyUploadLocalServiceUtil} to access the legacy upload local service.
	 */
	...
	@Override
	public LegacyUpload addLegacyUpload(LegacyUpload legacyUpload)
		throws SystemException {
		legacyUpload.setNew(true);

		return legacyUploadPersistence.update(legacyUpload);
	}
	 ...
	 */
	@Override
	public LegacyUpload createLegacyUpload(long id) {
		return legacyUploadPersistence.create(id);
	}
	...
	@Override
	public LegacyUpload deleteLegacyUpload(long id)
		throws PortalException, SystemException {
		return legacyUploadPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyUpload deleteLegacyUpload(LegacyUpload legacyUpload)
		throws SystemException {
		return legacyUploadPersistence.remove(legacyUpload);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyUpload.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyUploadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyUploadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyUpload fetchLegacyUpload(long id) throws SystemException {
		return legacyUploadPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyUpload getLegacyUpload(long id)
		throws PortalException, SystemException {
		return legacyUploadPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyUploadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyUpload> getLegacyUploads(int start, int end)
		throws SystemException {
		return legacyUploadPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyUploadsCount() throws SystemException {
		return legacyUploadPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyUpload updateLegacyUpload(LegacyUpload legacyUpload)
		throws SystemException {
		return legacyUploadPersistence.update(legacyUpload);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyUpload",
			legacyUploadLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyUploadPersistence.getDataSource();
	...
	private LegacyUploadLocalServiceClpInvoker _clpInvoker = new LegacyUploadLocalServiceClpInvoker();
}
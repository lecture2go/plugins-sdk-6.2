...
import de.uhh.l2g.plugins.migration.service.LegacyProducerLectureseriesLocalService;
...
/**
 * Provides the base implementation for the legacy producer lectureseries local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyProducerLectureseriesLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyProducerLectureseriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements LegacyProducerLectureseriesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyProducerLectureseriesLocalServiceUtil} to access the legacy producer lectureseries local service.
	 */
	...
	@Override
	public LegacyProducerLectureseries addLegacyProducerLectureseries(
		LegacyProducerLectureseries legacyProducerLectureseries)
		throws SystemException {
		legacyProducerLectureseries.setNew(true);

		return legacyProducerLectureseriesPersistence.update(legacyProducerLectureseries);
	}
	 ...
	 */
	@Override
	public LegacyProducerLectureseries createLegacyProducerLectureseries(
		long id) {
		return legacyProducerLectureseriesPersistence.create(id);
	}
	...
	@Override
	public LegacyProducerLectureseries deleteLegacyProducerLectureseries(
		long id) throws PortalException, SystemException {
		return legacyProducerLectureseriesPersistence.remove(id);
	}
	...
	public LegacyProducerLectureseries deleteLegacyProducerLectureseries(
		LegacyProducerLectureseries legacyProducerLectureseries)
		throws SystemException {
		return legacyProducerLectureseriesPersistence.remove(legacyProducerLectureseries);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyProducerLectureseries.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyProducerLectureseriesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyProducerLectureseriesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyProducerLectureseries fetchLegacyProducerLectureseries(long id)
		throws SystemException {
		return legacyProducerLectureseriesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyProducerLectureseries getLegacyProducerLectureseries(long id)
		throws PortalException, SystemException {
		return legacyProducerLectureseriesPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyProducerLectureseriesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyProducerLectureseries> getLegacyProducerLectureserieses(
		int start, int end) throws SystemException {
		return legacyProducerLectureseriesPersistence.findAll(start, end);
	}
	...
	public int getLegacyProducerLectureseriesesCount()
		throws SystemException {
		return legacyProducerLectureseriesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyProducerLectureseries updateLegacyProducerLectureseries(
		LegacyProducerLectureseries legacyProducerLectureseries)
		throws SystemException {
		return legacyProducerLectureseriesPersistence.update(legacyProducerLectureseries);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyProducerLectureseries",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyProducerLectureseriesPersistence.getDataSource();
	...
	private LegacyProducerLectureseriesLocalServiceClpInvoker _clpInvoker = new LegacyProducerLectureseriesLocalServiceClpInvoker();
}
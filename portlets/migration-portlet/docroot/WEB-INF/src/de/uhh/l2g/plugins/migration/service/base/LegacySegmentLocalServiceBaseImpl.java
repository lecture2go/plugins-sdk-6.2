...
/**
 * Provides the base implementation for the legacy segment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacySegmentLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacySegmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacySegmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacySegmentLocalServiceUtil} to access the legacy segment local service.
	 */
	...
	@Override
	public LegacySegment addLegacySegment(LegacySegment legacySegment)
		throws SystemException {
		legacySegment.setNew(true);

		return legacySegmentPersistence.update(legacySegment);
	}
	 ...
	 */
	@Override
	public LegacySegment createLegacySegment(long id) {
		return legacySegmentPersistence.create(id);
	}
	...
	@Override
	public LegacySegment deleteLegacySegment(long id)
		throws PortalException, SystemException {
		return legacySegmentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacySegment deleteLegacySegment(LegacySegment legacySegment)
		throws SystemException {
		return legacySegmentPersistence.remove(legacySegment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacySegment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacySegmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacySegmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacySegment fetchLegacySegment(long id) throws SystemException {
		return legacySegmentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacySegment getLegacySegment(long id)
		throws PortalException, SystemException {
		return legacySegmentPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacySegmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacySegment> getLegacySegments(int start, int end)
		throws SystemException {
		return legacySegmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacySegmentsCount() throws SystemException {
		return legacySegmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacySegment updateLegacySegment(LegacySegment legacySegment)
		throws SystemException {
		return legacySegmentPersistence.update(legacySegment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacySegment",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacySegmentPersistence.getDataSource();
	...
	private LegacySegmentLocalServiceClpInvoker _clpInvoker = new LegacySegmentLocalServiceClpInvoker();
}
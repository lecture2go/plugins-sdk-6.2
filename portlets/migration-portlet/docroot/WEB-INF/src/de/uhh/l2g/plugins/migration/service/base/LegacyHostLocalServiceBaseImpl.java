...
import de.uhh.l2g.plugins.migration.service.LegacyHostLocalService;
...
/**
 * Provides the base implementation for the legacy host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyHostLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyHostLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyHostLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyHostLocalServiceUtil} to access the legacy host local service.
	 */
	...
	@Override
	public LegacyHost addLegacyHost(LegacyHost legacyHost)
		throws SystemException {
		legacyHost.setNew(true);

		return legacyHostPersistence.update(legacyHost);
	}
	 ...
	 */
	@Override
	public LegacyHost createLegacyHost(long id) {
		return legacyHostPersistence.create(id);
	}
	...
	@Override
	public LegacyHost deleteLegacyHost(long id)
		throws PortalException, SystemException {
		return legacyHostPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyHost deleteLegacyHost(LegacyHost legacyHost)
		throws SystemException {
		return legacyHostPersistence.remove(legacyHost);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyHost.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyHostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return legacyHostPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyHostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyHost fetchLegacyHost(long id) throws SystemException {
		return legacyHostPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyHost getLegacyHost(long id)
		throws PortalException, SystemException {
		return legacyHostPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyHostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyHost> getLegacyHosts(int start, int end)
		throws SystemException {
		return legacyHostPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyHostsCount() throws SystemException {
		return legacyHostPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyHost updateLegacyHost(LegacyHost legacyHost)
		throws SystemException {
		return legacyHostPersistence.update(legacyHost);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyHost",
			legacyHostLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyHostPersistence.getDataSource();
	...
	private LegacyHostLocalServiceClpInvoker _clpInvoker = new LegacyHostLocalServiceClpInvoker();
}
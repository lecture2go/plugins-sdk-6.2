...
import de.uhh.l2g.plugins.migration.service.LegacyCoordinatorLocalService;
...
/**
 * Provides the base implementation for the legacy coordinator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyCoordinatorLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyCoordinatorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyCoordinatorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyCoordinatorLocalServiceUtil} to access the legacy coordinator local service.
	 */
	...
	@Override
	public LegacyCoordinator addLegacyCoordinator(
		LegacyCoordinator legacyCoordinator) throws SystemException {
		legacyCoordinator.setNew(true);

		return legacyCoordinatorPersistence.update(legacyCoordinator);
	}
	 ...
	 */
	@Override
	public LegacyCoordinator createLegacyCoordinator(long userId) {
		return legacyCoordinatorPersistence.create(userId);
	}
	...
	@Override
	public LegacyCoordinator deleteLegacyCoordinator(long userId)
		throws PortalException, SystemException {
		return legacyCoordinatorPersistence.remove(userId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyCoordinator deleteLegacyCoordinator(
		LegacyCoordinator legacyCoordinator) throws SystemException {
		return legacyCoordinatorPersistence.remove(legacyCoordinator);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyCoordinator.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyCoordinatorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyCoordinatorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyCoordinator fetchLegacyCoordinator(long userId)
		throws SystemException {
		return legacyCoordinatorPersistence.fetchByPrimaryKey(userId);
	}
	 ...
	 */
	@Override
	public LegacyCoordinator getLegacyCoordinator(long userId)
		throws PortalException, SystemException {
		return legacyCoordinatorPersistence.findByPrimaryKey(userId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyCoordinatorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyCoordinator> getLegacyCoordinators(int start, int end)
		throws SystemException {
		return legacyCoordinatorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyCoordinatorsCount() throws SystemException {
		return legacyCoordinatorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyCoordinator updateLegacyCoordinator(
		LegacyCoordinator legacyCoordinator) throws SystemException {
		return legacyCoordinatorPersistence.update(legacyCoordinator);
	}
...
>>>>>>> refs/remotes/lecture2go/master
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyCoordinator",
			legacyCoordinatorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyCoordinatorPersistence.getDataSource();
...
>>>>>>> refs/remotes/lecture2go/master
	...
	private LegacyCoordinatorLocalServiceClpInvoker _clpInvoker = new LegacyCoordinatorLocalServiceClpInvoker();
}

...
import de.uhh.l2g.plugins.migration.service.LegacyLectureSeriesFacilityLocalService;
...
/**
 * Provides the base implementation for the legacy lecture series facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyLectureSeriesFacilityLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyLectureSeriesFacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements LegacyLectureSeriesFacilityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyLectureSeriesFacilityLocalServiceUtil} to access the legacy lecture series facility local service.
	 */
	...
	@Override
	public LegacyLectureSeriesFacility addLegacyLectureSeriesFacility(
		LegacyLectureSeriesFacility legacyLectureSeriesFacility)
		throws SystemException {
		legacyLectureSeriesFacility.setNew(true);

		return legacyLectureSeriesFacilityPersistence.update(legacyLectureSeriesFacility);
	}
	...
	public LegacyLectureSeriesFacility deleteLegacyLectureSeriesFacility(
		LegacyLectureSeriesFacility legacyLectureSeriesFacility)
		throws SystemException {
		return legacyLectureSeriesFacilityPersistence.remove(legacyLectureSeriesFacility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyLectureSeriesFacility.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyLectureSeriesFacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyLectureSeriesFacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legacyLectureSeriesFacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyLectureSeriesFacility> getLegacyLectureSeriesFacilities(
		int start, int end) throws SystemException {
		return legacyLectureSeriesFacilityPersistence.findAll(start, end);
	}
	...
	public int getLegacyLectureSeriesFacilitiesCount()
		throws SystemException {
		return legacyLectureSeriesFacilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyLectureSeriesFacility updateLegacyLectureSeriesFacility(
		LegacyLectureSeriesFacility legacyLectureSeriesFacility)
		throws SystemException {
		return legacyLectureSeriesFacilityPersistence.update(legacyLectureSeriesFacility);
	}
...
>>>>>>> refs/remotes/lecture2go/master
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyLectureSeriesFacility",
			legacyLectureSeriesFacilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyLectureSeriesFacilityPersistence.getDataSource();
...
>>>>>>> refs/remotes/lecture2go/master
	...
	private LegacyLectureSeriesFacilityLocalServiceClpInvoker _clpInvoker = new LegacyLectureSeriesFacilityLocalServiceClpInvoker();
}

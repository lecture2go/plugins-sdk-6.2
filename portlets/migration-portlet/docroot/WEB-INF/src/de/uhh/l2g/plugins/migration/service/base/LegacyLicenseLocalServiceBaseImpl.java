...
import de.uhh.l2g.plugins.migration.service.LegacyLicenseLocalService;
...
/**
 * Provides the base implementation for the legacy license local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyLicenseLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyLicenseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyLicenseLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyLicenseLocalServiceUtil} to access the legacy license local service.
	 */
	...
	@Override
	public LegacyLicense addLegacyLicense(LegacyLicense legacyLicense)
		throws SystemException {
		legacyLicense.setNew(true);

		return legacyLicensePersistence.update(legacyLicense);
	}
	 ...
	 */
	@Override
	public LegacyLicense createLegacyLicense(long id) {
		return legacyLicensePersistence.create(id);
	}
	...
	@Override
	public LegacyLicense deleteLegacyLicense(long id)
		throws PortalException, SystemException {
		return legacyLicensePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyLicense deleteLegacyLicense(LegacyLicense legacyLicense)
		throws SystemException {
		return legacyLicensePersistence.remove(legacyLicense);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyLicense.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyLicensePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyLicensePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyLicense fetchLegacyLicense(long id) throws SystemException {
		return legacyLicensePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyLicense getLegacyLicense(long id)
		throws PortalException, SystemException {
		return legacyLicensePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyLicensePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyLicense> getLegacyLicenses(int start, int end)
		throws SystemException {
		return legacyLicensePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyLicensesCount() throws SystemException {
		return legacyLicensePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyLicense updateLegacyLicense(LegacyLicense legacyLicense)
		throws SystemException {
		return legacyLicensePersistence.update(legacyLicense);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyLicense",
			legacyLicenseLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyLicensePersistence.getDataSource();
	...
	private LegacyLicenseLocalServiceClpInvoker _clpInvoker = new LegacyLicenseLocalServiceClpInvoker();
}
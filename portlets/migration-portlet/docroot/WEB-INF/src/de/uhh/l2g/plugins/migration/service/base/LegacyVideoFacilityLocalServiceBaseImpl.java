...
import de.uhh.l2g.plugins.migration.service.LegacyVideoFacilityLocalService;
...
/**
 * Provides the base implementation for the legacy video facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyVideoFacilityLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyVideoFacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyVideoFacilityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyVideoFacilityLocalServiceUtil} to access the legacy video facility local service.
	 */
	...
	@Override
	public LegacyVideoFacility addLegacyVideoFacility(
		LegacyVideoFacility legacyVideoFacility) throws SystemException {
		legacyVideoFacility.setNew(true);

		return legacyVideoFacilityPersistence.update(legacyVideoFacility);
	}
	 ...
	 */
	@Override
	public LegacyVideoFacility createLegacyVideoFacility(long videoFacilityId) {
		return legacyVideoFacilityPersistence.create(videoFacilityId);
	}
	...
	@Override
	public LegacyVideoFacility deleteLegacyVideoFacility(long videoFacilityId)
		throws PortalException, SystemException {
		return legacyVideoFacilityPersistence.remove(videoFacilityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyVideoFacility deleteLegacyVideoFacility(
		LegacyVideoFacility legacyVideoFacility) throws SystemException {
		return legacyVideoFacilityPersistence.remove(legacyVideoFacility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyVideoFacility.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyVideoFacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyVideoFacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyVideoFacility fetchLegacyVideoFacility(long videoFacilityId)
		throws SystemException {
		return legacyVideoFacilityPersistence.fetchByPrimaryKey(videoFacilityId);
	}
	 ...
	 */
	@Override
	public LegacyVideoFacility getLegacyVideoFacility(long videoFacilityId)
		throws PortalException, SystemException {
		return legacyVideoFacilityPersistence.findByPrimaryKey(videoFacilityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyVideoFacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyVideoFacility> getLegacyVideoFacilities(int start, int end)
		throws SystemException {
		return legacyVideoFacilityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyVideoFacilitiesCount() throws SystemException {
		return legacyVideoFacilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyVideoFacility updateLegacyVideoFacility(
		LegacyVideoFacility legacyVideoFacility) throws SystemException {
		return legacyVideoFacilityPersistence.update(legacyVideoFacility);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyVideoFacility",
			legacyVideoFacilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyVideoFacilityPersistence.getDataSource();
	...
	private LegacyVideoFacilityLocalServiceClpInvoker _clpInvoker = new LegacyVideoFacilityLocalServiceClpInvoker();
}
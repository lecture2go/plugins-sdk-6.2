...
import de.uhh.l2g.plugins.migration.service.LegacyFacilityLocalService;
...
/**
 * Provides the base implementation for the legacy facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyFacilityLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyFacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyFacilityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyFacilityLocalServiceUtil} to access the legacy facility local service.
	 */
	...
	@Override
	public LegacyFacility addLegacyFacility(LegacyFacility legacyFacility)
		throws SystemException {
		legacyFacility.setNew(true);

		return legacyFacilityPersistence.update(legacyFacility);
	}
	 ...
	 */
	@Override
	public LegacyFacility createLegacyFacility(long id) {
		return legacyFacilityPersistence.create(id);
	}
	...
	@Override
	public LegacyFacility deleteLegacyFacility(long id)
		throws PortalException, SystemException {
		return legacyFacilityPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyFacility deleteLegacyFacility(LegacyFacility legacyFacility)
		throws SystemException {
		return legacyFacilityPersistence.remove(legacyFacility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyFacility.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyFacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyFacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyFacility fetchLegacyFacility(long id)
		throws SystemException {
		return legacyFacilityPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyFacility getLegacyFacility(long id)
		throws PortalException, SystemException {
		return legacyFacilityPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyFacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyFacility> getLegacyFacilities(int start, int end)
		throws SystemException {
		return legacyFacilityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyFacilitiesCount() throws SystemException {
		return legacyFacilityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyFacility updateLegacyFacility(LegacyFacility legacyFacility)
		throws SystemException {
		return legacyFacilityPersistence.update(legacyFacility);
	}
...
>>>>>>> refs/remotes/lecture2go/master
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyFacility",
			legacyFacilityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyFacilityPersistence.getDataSource();
...
>>>>>>> refs/remotes/lecture2go/master
	...
	private LegacyFacilityLocalServiceClpInvoker _clpInvoker = new LegacyFacilityLocalServiceClpInvoker();
}

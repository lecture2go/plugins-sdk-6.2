...
import de.uhh.l2g.plugins.migration.service.LegacyL2gSysLocalService;
...
/**
 * Provides the base implementation for the legacy l2g sys local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyL2gSysLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyL2gSysLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyL2gSysLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyL2gSysLocalServiceUtil} to access the legacy l2g sys local service.
	 */
	...
	@Override
	public LegacyL2gSys addLegacyL2gSys(LegacyL2gSys legacyL2gSys)
		throws SystemException {
		legacyL2gSys.setNew(true);

		return legacyL2gSysPersistence.update(legacyL2gSys);
	}
	 ...
	 */
	@Override
	public LegacyL2gSys createLegacyL2gSys(int id) {
		return legacyL2gSysPersistence.create(id);
	}
	...
	@Override
	public LegacyL2gSys deleteLegacyL2gSys(int id)
		throws PortalException, SystemException {
		return legacyL2gSysPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyL2gSys deleteLegacyL2gSys(LegacyL2gSys legacyL2gSys)
		throws SystemException {
		return legacyL2gSysPersistence.remove(legacyL2gSys);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyL2gSys.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyL2gSysPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyL2gSysPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyL2gSys fetchLegacyL2gSys(int id) throws SystemException {
		return legacyL2gSysPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyL2gSys getLegacyL2gSys(int id)
		throws PortalException, SystemException {
		return legacyL2gSysPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyL2gSysPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyL2gSys> getLegacyL2gSyses(int start, int end)
		throws SystemException {
		return legacyL2gSysPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyL2gSysesCount() throws SystemException {
		return legacyL2gSysPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyL2gSys updateLegacyL2gSys(LegacyL2gSys legacyL2gSys)
		throws SystemException {
		return legacyL2gSysPersistence.update(legacyL2gSys);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyL2gSys",
			legacyL2gSysLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyL2gSysPersistence.getDataSource();
	...
	private LegacyL2gSysLocalServiceClpInvoker _clpInvoker = new LegacyL2gSysLocalServiceClpInvoker();
}
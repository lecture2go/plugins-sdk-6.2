...
import de.uhh.l2g.plugins.migration.service.LegacyLectureSeriesLocalService;
...
/**
 * Provides the base implementation for the legacy lecture series local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.uhh.l2g.plugins.migration.service.impl.LegacyLectureSeriesLocalServiceImpl}.
 * </p>
 *
 * @author unihh
 ...
 * @generated
 */
public abstract class LegacyLectureSeriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LegacyLectureSeriesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.uhh.l2g.plugins.migration.service.LegacyLectureSeriesLocalServiceUtil} to access the legacy lecture series local service.
	 */
	...
	@Override
	public LegacyLectureSeries addLegacyLectureSeries(
		LegacyLectureSeries legacyLectureSeries) throws SystemException {
		legacyLectureSeries.setNew(true);

		return legacyLectureSeriesPersistence.update(legacyLectureSeries);
	}
	 ...
	 */
	@Override
	public LegacyLectureSeries createLegacyLectureSeries(long id) {
		return legacyLectureSeriesPersistence.create(id);
	}
	...
	@Override
	public LegacyLectureSeries deleteLegacyLectureSeries(long id)
		throws PortalException, SystemException {
		return legacyLectureSeriesPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LegacyLectureSeries deleteLegacyLectureSeries(
		LegacyLectureSeries legacyLectureSeries) throws SystemException {
		return legacyLectureSeriesPersistence.remove(legacyLectureSeries);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LegacyLectureSeries.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return legacyLectureSeriesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return legacyLectureSeriesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LegacyLectureSeries fetchLegacyLectureSeries(long id)
		throws SystemException {
		return legacyLectureSeriesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public LegacyLectureSeries getLegacyLectureSeries(long id)
		throws PortalException, SystemException {
		return legacyLectureSeriesPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return legacyLectureSeriesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LegacyLectureSeries> getLegacyLectureSerieses(int start, int end)
		throws SystemException {
		return legacyLectureSeriesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLegacyLectureSeriesesCount() throws SystemException {
		return legacyLectureSeriesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LegacyLectureSeries updateLegacyLectureSeries(
		LegacyLectureSeries legacyLectureSeries) throws SystemException {
		return legacyLectureSeriesPersistence.update(legacyLectureSeries);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("de.uhh.l2g.plugins.migration.model.LegacyLectureSeries",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = legacyLectureSeriesPersistence.getDataSource();
	...
	private LegacyLectureSeriesLocalServiceClpInvoker _clpInvoker = new LegacyLectureSeriesLocalServiceClpInvoker();
}